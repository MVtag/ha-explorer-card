...
export interface ExplorerPresence { id:string; name?:string; type?:PresenceObjectType; x?:number; y?:number; room_id?:string; color?:string; icon?:string; avatar?:string; visible?:boolean; trail_visible?:boolean; trail_color?:string; trail_duration?:number; history_visible?:boolean; history_duration?:number; entity_binding?:PresenceEntityBinding; }
