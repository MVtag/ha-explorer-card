...
export interface ExplorerCardConfig { type:string; title?:string; image?:string; background?:string; floorplan_meters?:ExplorerFloorplanMeters; min_zoom?:number; max_zoom?:number; initial_zoom?:number; fit_mode?:FloorplanFitMode; appearance?:ExplorerAppearanceConfig; movement_history?:ExplorerMovementHistoryConfig; rooms?:ExplorerRoom[]; zones?:ExplorerZone[]; route_nodes?:ExplorerRouteNode[]; route_graph_edges?:ExplorerRouteGraphEdge[]; routes?:ExplorerRoute[]; openings?:ExplorerOpening[]; presences?:ExplorerPresence[]; }
