...
export class ExplorerThemedCanvas extends ExplorerLivingCanvas {
  ...
  private createThemeDefs(): SVGDefsElement {
    ...
    this.setAttributes(paperNoise, {
      id: `${this.artifactId}-grain`,
      x: "-10%",
      y: "-10%",
      width: "120%",
      height: "120%",
    ...
    this.setAttributes(colorMatrix, {
      in: "noise",
      type: "matrix",
      values: "0 0 0 0 0.30  0 0 0 0 0.20  0 0 0 0 0.11  0 0 0 .24 0",
    });
  ...
  private createPaperLayer(): SVGGElement {
    ...
    this.setAttributes(grain, {
      ...
      fill: "#6b482d",
      opacity: ".32",
      filter: `url(#${this.artifactId}-grain)`,
    });
    grain.style.mixBlendMode = "multiply";
    group.appendChild(grain);

    const vignette = this.createSvg("rect");
    this.setAttributes(vignette, {
      x: "0",
      y: "0",
      width: "1000",
      height: "1000",
      fill: `url(#${this.artifactId}-vignette)`,
      opacity: ".58",
    });
  ...
  private createCompass(): SVGGElement {
    ...
    this.setAttributes(north, {
      d: "M 0 -42 L 8 -8 L 0 -15 L -8 -8 Z",
      fill: "#5a3924",
      "fill-opacity": ".76",
    });
    ...
    this.setAttributes(south, {
      d: "M 0 42 L 6 9 L 0 15 L -6 9 Z",
      fill: "#7b5636",
      "fill-opacity": ".42",
    });
  ...
  private syncThemeArtifacts(): void {
    ...
    if (!reduceMotion && !this.hasRevealedEnchanted) {
      ...
      compass.animate(
        [{ opacity: 0 }, { opacity: 0.62 }],
        { duration: 1100, delay: 180, fill: "both", easing: "ease-out" },
      );
    }
  }
