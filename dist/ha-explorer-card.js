...
const Fr = (e) => new ur(typeof e == "string" ? e : e + "", void 0, di), j = (e, ...t) => {
...
const { is: Vr, defineProperty: Kr, getOwnPropertyDescriptor: Wr, getOwnPropertyNames: Gr, getOwnPropertySymbols: Ur, getPrototypeOf: Xr } = Object, qt = globalThis, Ni = qt.trustedTypes, Yr = Ni ? Ni.emptyScript : "", Qr = qt.reactiveElementPolyfillSupport, $e = (e, t) => e, Et = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Yr : null;
      break;
  ...
  return i;
} }, pi = (e, t) => !Vr(e, t), Pi = { attribute: !0, type: String, converter: Et, reflect: !1, useDefault: !1, hasChanged: pi };
...
Be.elementStyles = [], Be.shadowRootOptions = { mode: "open" }, Be[$e("elementProperties")] = /* @__PURE__ */ new Map(), Be[$e("finalized")] = /* @__PURE__ */ new Map(), Qr?.({ ReactiveElement: Be }), (qt.reactiveElementVersions ??= []).push("2.1.2");
const hi = globalThis, Ri = (e) => e, Nt = hi.trustedTypes, Mi = Nt ? Nt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, gr = "$lit$", ke = `lit$${Math.random().toFixed(9).slice(2)}$`, mr = "?" + ke, Jr = `<${mr}>`, Me = document, tt = () => Me.createComment(""), it = (e) => e === null || typeof e != "object" && typeof e != "function", ui = Array.isArray, $r = (e) => ui(e) || typeof e?.[Symbol.iterator] == "function", Ft = `[ 	
\f\r]`, Je = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zi = /-->/g, Ti = />/g, Ee = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Di = /'/g, ji = /"/g, fr = /^(?:script|style|textarea|title)$/i, br = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), u = br(1), R = br(2), re = /* @__PURE__ */ Symbol.for("lit-noChange"), f = /* @__PURE__ */ Symbol.for("lit-nothing"), Ii = /* @__PURE__ */ new WeakMap(), Pe = Me.createTreeWalker(Me, 129);
function yr(e, t) {
...
const _r = (e, t) => {
  ...
  for (let a = 0; a < i; a++) {
    const l = e[a];
    let c, d, p = -1, h = 0;
    for (; h < l.length && (s.lastIndex = h, d = s.exec(l), d !== null); ) h = s.lastIndex, s === Je ? d[1] === "!--" ? s = zi : d[1] !== void 0 ? s = Ti : d[2] !== void 0 ? (fr.test(d[2]) && (o = RegExp("</" + d[2], "g")), s = Ee) : d[3] !== void 0 && (s = Ee) : s === Ee ? d[0] === ">" ? (s = o ?? Je, p = -1) : d[1] === void 0 ? p = -2 : (p = s.lastIndex - d[2].length, c = d[1], s = d[3] === void 0 ? Ee : d[3] === '"' ? ji : Di) : s === ji || s === Di ? s = Ee : s === zi || s === Ti ? s = Je : (s = Ee, o = void 0);
      ...
      if (o.nodeType === 1) {
        ...
        if (fr.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let g = 0; g < h; g++) o.append(p[g], tt()), Pe.nextNode(), l.push({ type: 2, index: ++n });
            o.append(p[h], tt());
          }
        }
...
class pt {
  ...
  _$AC(t) {
    ...
    return i === void 0 && Ii.set(t.strings, i = new rt(t)), i;
  }
  k(t) {
...
const Ne = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, mi = (e) => (...t) => ({ _$litDirective$: e, values: t });
let fi = class {
  constructor(t) {
  }
  get _$AU() {
...
function xr(e, t, i) {
  ...
  if (e.kind === "temperature") {
    ...
    return Number.isFinite(c) ? { index: t, reaction: e, active: !0, currentState: n.state, activeStates: o, intensity: 1, numericValue: c, unit: qi(n.attributes) } : { index: t, reaction: e, active: !1, currentState: n.state, activeStates: o, intensity: 0, unit: qi(n.attributes), reason: "state_inactive" };
  }
  const s = n.state.trim().toLowerCase(), a = o.map((c) => c.toLowerCase()).includes(s);
  let l = 0;
  return a && (e.kind === "light" ? l = vo(n.attributes) * Li(e) : l = Li(e)), {
    index: t,
    reaction: e,
    active: a,
...
let be = class extends O {
  ...
  get statuses() {
    return this.room ? Pt(this.room, (e) => {
...
var Eo = Object.defineProperty, No = Object.getOwnPropertyDescriptor, Y = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? No(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Eo(t, i, o), o;
};
const Bi = { width: 16, height: 9, status: "idle" }, Po = { person: "●", pet: "◆", robot: "■", vehicle: "▰", object: "✦" }, Ro = "script,foreignObject,iframe,object,embed,link,meta,audio,video,canvas";
function Hi(e) {
  try {
...
let V = class extends O {
  constructor() {
    super(...arguments), this.image = "", this.rooms = [], this.presences = [], this.minZoom = 1, this.maxZoom = 6, this.initialZoom = 1, this.fitMode = "contain", this.viewport = { zoom: 1, x: 0, y: 0 }, this.metadata = { ...Bi }, this.imageSource = "", this.svgMarkup = "", this.loadError = "", this.activePointers = /* @__PURE__ */ new Map(), this.imageRequest = 0;
  }
  connectedCallback() {
  ...
  async loadFloorplan() {
    ...
    try {
      Hi(this.image) ? await this.loadSvgFloorplan(e) : await this.loadRasterFloorplan(e);
    } catch (t) {
  ...
  async loadSvgFloorplan(e) {
    ...
    if (e !== this.imageRequest) return;
    const r = new DOMParser().parseFromString(i, "image/svg+xml"), o = Do(r), n = Mo(o);
  ...
  renderPresences() {
    return this.presences.filter((e) => e.visible !== !1).map((e, t) => {
      const i = e.type ?? "person", r = e.id === this.selectedPresence?.id, o = (e.x ?? 0.5) * x, n = (e.y ?? 0.5) * x, s = e.icon ?? Po[i], a = To(e.avatar), l = e.color ?? "#03a9f4", c = r ? 31 : 25, d = c * 2, p = `presence-avatar-${t}`, h = r ? 58 : 52;
...
function qo(e, t, i) {
  ...
  const r = e.condition.entity?.trim(), o = Lo(e);
  if (!r)
    return {
      index: t,
      edge: e,
...
function ht(e, t) {
  ...
  return (e.route_graph_edges ?? []).map((r, o) => {
    const n = qo(r, o, t), a = [r.from, r.to].filter((h) => h.kind === "node").map((h) => i.get(h.id)).filter((h) => !!h).map((h) => Ve(h, t)).filter((h) => h.conditional), c = a.find((h) => !h.active) ?? (n.conditional ? void 0 : a[0]), d = n.active && a.every((h) => h.active), p = n.conditional || a.length > 0;
    return c ? {
      ...n,
      conditional: p,
      active: d,
...
function Ho(e, t, i, r, o) {
  ...
  h.reverse();
  const b = h.map((m) => l.get(m)).map((m) => m ? Io(e, m) : void 0).filter((m) => !!m);
  if (!(b.length < 2))
    return {
      source: "graph",
      hops: b,
...
function Ki(e, t) {
  ...
  i.forEach((A) => {
    const P = fe(A.from), M = fe(A.to), I = Fo(A);
    P === M && (n += 1), s.has(I) && (o += 1), s.add(I);
  ...
  const S = ht(e, t), w = S.filter((A) => !A.active), k = (e.route_nodes ?? []).map((A) => Ve(A, t)).filter((A) => A.conditional), E = k.filter((A) => !A.active), N = /* @__PURE__ */ new Set();
  return S.forEach((A) => {
...
let Ke = class extends V {
  ...
  updated(e) {
    ...
    t.forEach((n, s) => {
      ...
      if (o.add(n.id), this.activeAnimations.get(n.id)?.remove(), this.activeAnimations.delete(n.id), !r && c && (Math.abs(c.x - l.x) > 0.01 || Math.abs(c.y - l.y) > 0.01)) {
        ...
        g.setAttribute("attributeName", "transform"), g.setAttribute("attributeType", "XML"), g.setAttribute("type", "translate"), g.setAttribute("values", h.map((b) => `${b.x} ${b.y}`).join(";")), g.setAttribute("keyTimes", this.buildKeyTimes(h).join(";")), g.setAttribute("dur", `${Vt}ms`), g.setAttribute("begin", "indefinite"), g.setAttribute("fill", "freeze"), g.setAttribute("calcMode", "linear"), a.appendChild(g), this.activeAnimations.set(n.id, g), g.beginElement(), window.setTimeout(() => {
  ...
  createFootsteps(e) {
    ...
    for (let n = 0; n < o; n += 1) {
      ...
      const d = c.length > 0 ? (a - l) / c.length : 0, p = c.end.x - c.start.x, h = c.end.y - c.start.y, g = n % 2 === 0 ? -1 : 1, b = c.length > 0 ? -h / c.length : 0, m = c.length > 0 ? p / c.length : 0, y = 9 * g, S = c.start.x + p * d + b * y, w = c.start.y + h * d + m * y, k = Math.atan2(h, p) * 180 / Math.PI + 90, E = Math.round(s * Vt), N = document.createElementNS(F, "g");
      N.setAttribute("transform", `translate(${S} ${w}) rotate(${k + g * 8})`), N.setAttribute("opacity", "0");
      ...
      M.setAttribute("attributeName", "opacity"), M.setAttribute("values", "0;0.72;0.56;0"), M.setAttribute("keyTimes", "0;0.08;0.58;1"), M.setAttribute("begin", "indefinite"), M.setAttribute("dur", `${Wi}ms`), M.setAttribute("fill", "freeze"), N.append(A, P, M), t.appendChild(N), window.setTimeout(() => {
        N.isConnected && M.beginElement();
      }, E), window.setTimeout(() => N.remove(), E + Wi + 120);
    }
  }
};
Bt([
...
let Mt = class extends Ke {
  ...
  appendPointBackdrop(e, t, i, r = 11) {
    const o = document.createElementNS(q, "circle");
  ...
  appendLightPoint(e, t, i) {
    ...
    if (t.active) {
      ...
      [[74, 0.025], [52, 0.055], [34, 0.12]].forEach(([c, d], p) => {
        const h = document.createElementNS(q, "circle");
        if (h.setAttribute("class", `magical-light-glow glow-${p + 1}`), h.setAttribute("r", String(c * (0.82 + n * 0.34))), h.setAttribute("fill", r), h.setAttribute("fill-opacity", String(d + n * d * 1.8)), h.setAttribute("stroke", "none"), e.appendChild(h), !i && p === 1) {
          const g = document.createElementNS(q, "animate");
      ...
      const a = document.createElementNS(q, "circle"), l = 24 + n * 24;
      if (a.setAttribute("class", "light-halo"), a.setAttribute("r", String(l)), a.setAttribute("fill", r), a.setAttribute("fill-opacity", String(0.08 + n * 0.18)), a.setAttribute("stroke", r), a.setAttribute("stroke-width", "2"), a.setAttribute("stroke-opacity", String(0.1 + n * 0.18)), a.setAttribute("vector-effect", "non-scaling-stroke"), e.appendChild(a), !i) {
        const c = document.createElementNS(q, "animate");
    ...
    const o = document.createElementNS(q, "text");
  ...
  appendMotionPoint(e, t, i) {
    ...
    if (n.setAttribute("r", "15"), n.setAttribute("fill", "none"), n.setAttribute("stroke", r), n.setAttribute("stroke-width", "3"), n.setAttribute("stroke-opacity", ".78"), n.setAttribute("vector-effect", "non-scaling-stroke"), e.insertBefore(n, e.firstChild), !i) {
      const s = document.createElementNS(q, "animate");
  ...
  appendMediaPoint(e, t) {
    ...
    const r = document.createElementNS(q, "rect");
    ...
    const o = document.createElementNS(q, "path");
  ...
  appendOpeningPoint(e, t) {
    ...
    const r = document.createElementNS(q, "text");
  ...
  appendFireplacePoint(e, t, i) {
    ...
    if (t.active) {
      ...
      const l = document.createElementNS(q, "circle");
      ...
      const c = document.createElementNS(q, "circle");
      if (c.setAttribute("class", "fireplace-glow fireplace-glow-inner"), c.setAttribute("r", String(s * 0.56)), c.setAttribute("fill", "var(--explorer-room-fireplace-hot, #e7a253)"), c.setAttribute("fill-opacity", String(0.12 + 0.17 * o)), e.appendChild(c), !i) {
        const d = document.createElementNS(q, "animate");
        ...
        const p = document.createElementNS(q, "animate");
    ...
    const a = document.createElementNS(q, "path");
  ...
  appendTemperaturePoint(e, t) {
    const i = this.temperatureColor(t), r = this.formatTemperature(t), o = Math.max(58, 24 + r.length * 8.2), n = document.createElementNS(q, "rect");
    ...
    const s = document.createElementNS(q, "text");
  ...
  appendReactionPoint(e, t, i, r) {
    const o = _e(t, i.reaction), n = document.createElementNS(q, "g");
  ...
  syncRoomReactionOverlay() {
    ...
    const t = this.rooms.flatMap((a) => Pt(a, (l) => this.entityState(l)).map((l) => ({ room: a, status: l })));
    if (!t.length) return;
    const i = window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = document.createElementNS(q, "g");
...
const T = "http://www.w3.org/2000/svg", Kt = 3e4;
let nt = class extends Mt {
  ...
  roomTemperatures() {
    return this.rooms.flatMap((e) => {
      ...
      const t = Pt(e, (r) => this.atmosphereEntityState(r)).filter((r) => r.reaction.kind === "temperature" && r.active).map((r) => this.temperatureCelsius(r)).filter((r) => r !== void 0);
      if (!t.length) return [];
  ...
  appendFireplaceAtmosphere(e, t, i, r, o) {
    ...
    [
      ...
      if (k.setAttribute("class", "fireplace-ember"), k.setAttribute("cx", String(m)), k.setAttribute("cy", String(y)), k.setAttribute("r", String(S)), k.setAttribute("fill", w % 2 === 0 ? "var(--explorer-fireplace-ember, #d96532)" : "var(--explorer-fireplace-atmosphere-core, #f0b65c)"), k.setAttribute("opacity", r ? String(0.28 + s * 0.22) : "0"), c.appendChild(k), !r) {
        ...
        N.setAttribute("attributeName", "opacity"), N.setAttribute("values", `0;${0.32 + s * 0.45};${0.16 + s * 0.22};0`), N.setAttribute("keyTimes", "0;0.18;0.68;1"), N.setAttribute("dur", `${2.4 + w % 3 * 0.42}s`), N.setAttribute("begin", `${(w * 0.37 + o * 0.11).toFixed(2)}s`), N.setAttribute("repeatCount", "indefinite"), k.appendChild(N);
      }
    });
  ...
  syncFireplaceAtmosphere() {
    ...
    const t = this.rooms.flatMap(
      (l) => Pt(l, (c) => this.atmosphereEntityState(c)).filter((c) => c.reaction.kind === "fireplace" && c.active).map((c) => ({ room: l, status: c }))
    );
    if (!t.length) return;
    const i = document.createElementNS(T, "g");
...
let ze = class extends We {
  ...
  polishCreateTrail(e, t) {
    ...
    for (let p = 0; p < d; p += 1) {
      ...
      const y = m.length > 0 ? (g - b) / m.length : 0, S = m.end.x - m.start.x, w = m.end.y - m.start.y, k = p % 2 === 0 ? -1 : 1, E = r === "person" ? un[o] ?? 8 : r === "pet" ? 6 : 0, N = r === "person" ? gn[o] ?? 7 : E ? 7 : 0, A = m.length > 0 ? -w / m.length : 0, P = m.length > 0 ? S / m.length : 0, M = m.start.x + S * y + A * E * k, I = m.start.y + w * y + P * E * k, G = Math.atan2(w, S) * 180 / Math.PI + 90, J = Math.round(h * dn), z = this.polishCreateSvg("g");
      z.setAttribute("class", `trail-mark trail-${r}${r === "person" ? ` trail-person-v${o + 1}` : ""}`), z.setAttribute("data-presence-id", t.id), r === "person" && z.setAttribute("data-trail-style", String(o + 1)), z.setAttribute("transform", `translate(${M} ${I}) rotate(${G + (E ? k * N : 0)})`), z.setAttribute("opacity", "0"), this.polishAppendTrailShape(z, r, n, o);
    ...
    for (const [a, l] of this.movementHistorySamples) {
      ...
      if (d === "person" && this.movementHistory.show_rooms !== !1) {
        ...
        for (const [m, y] of b) {
          ...
          this.polishSetAttributes(k, { points: S.points.map(([E, N]) => `${E * x},${N * x}`).join(" "), fill: h, "fill-opacity": String(w), stroke: h, "stroke-opacity": String(w * 0.9), "stroke-width": "2", "vector-effect": "non-scaling-stroke", "data-presence-id": a }), r.appendChild(k);
        }
      }
      for (let b = 1; b < l.length; b += 1) {
        ...
        for (let k = 1; k < S.length; k += 1) {
          const E = S[k - 1], N = S[k], A = N.x - E.x, P = N.y - E.y, M = Math.hypot(A, P), I = Math.atan2(P, A) * 180 / Math.PI;
          if (d === "robot") {
            if (this.petRobotTrails.show_robot_route === !1) continue;
            const L = this.polishCreateSvg("line");
            if (this.polishSetAttributes(L, { x1: String(E.x), y1: String(E.y), x2: String(N.x), y2: String(N.y), stroke: h, "stroke-width": "7", "stroke-linecap": "round", "stroke-opacity": String(w), "vector-effect": "non-scaling-stroke", "data-presence-id": a }), L.setAttribute("class", "robot-history-route"), o.appendChild(L), this.petRobotTrails.robot_direction_arrows !== !1 && M > 45) {
              const H = this.polishCreateSvg("path"), U = (E.x + N.x) / 2, je = (E.y + N.y) / 2;
          ...
          for (let L = 1; L <= J; L += 1) {
            const H = L / (J + 1), U = L % 2 === 0 ? -1 : 1, je = M > 0 ? -P / M : 0, Ce = M > 0 ? A / M : 0, Qe = d === "pet" ? 7 : 6, $ = this.polishCreateSvg("g");
            $.setAttribute("class", `movement-history-mark trail-${d}${d === "person" ? ` trail-person-v${g + 1}` : ""}`), $.setAttribute("data-presence-id", a), $.setAttribute("transform", `translate(${E.x + A * H + je * Qe * U} ${E.y + P * H + Ce * Qe * U}) rotate(${z + U * 4}) scale(${d === "pet" ? 0.72 : 0.62})`), $.setAttribute("opacity", String(w)), this.polishAppendTrailShape($, d, h, g), o.appendChild($);
          }
        }
      }
    }
...
let Ge = class extends st {
  ...
  drawDoor(e, t, i) {
    ...
    for (const $ of [w, k]) this.line(z, $.x - y * L / 2, $.y - S * L / 2, $.x + y * L / 2, $.y + S * L / 2, "door-jamb");
    r && this.line(z, E.x, E.y, N.x, N.y, "door-closed-guide"), this.line(z, E.x, E.y, G.x, G.y, "door-leaf");
    ...
    if (H.setAttribute("cx", String(E.x)), H.setAttribute("cy", String(E.y)), H.setAttribute("r", "4.2"), H.setAttribute("class", "opening-hinge"), z.appendChild(H), r) {
      const $ = document.createElementNS(_, "path"), Ai = yt(A), Si = I, Ir = E.x + Math.cos(Ai) * n, Lr = E.y + Math.sin(Ai) * n, qr = E.x + Math.cos(Si) * n, Or = E.y + Math.sin(Si) * n, Br = P > 0 ? 1 : 0, Hr = Math.abs(a) > 180 ? 1 : 0;
      $.setAttribute("d", `M ${Ir} ${Lr} A ${n} ${n} 0 ${Hr} ${Br} ${qr} ${Or}`), $.setAttribute("class", "door-swing"), z.appendChild($);
    }
  ...
  drawWindow(e, t, i) {
    ...
    const E = a + h * 17, N = l + g * 17, A = document.createElementNS(_, "circle");
    A.setAttribute("cx", String(E)), A.setAttribute("cy", String(N)), A.setAttribute("r", "5.2"), A.setAttribute("class", "opening-status-dot"), k.appendChild(A), this.appendAgeIndicator(k, E, N, o);
    const P = document.createElementNS(_, "title");
    P.textContent = `${t.name ?? t.id} · vindue ${r ? "åbent" : "lukket"}${o ? ` · ${o.description}` : ""}${t.state_binding ? ` · ${t.state_binding.entity}` : " · ingen entity"}`, k.appendChild(P), e.appendChild(k);
  }
};
...
let Se = class extends Ge {
  ...
  appendClouds(e, t = this.cloudFilterId) {
    ...
    for (const [a, l, c, d, p] of s) {
      ...
      }), w.appendChild(N), m.appendChild(w);
      const A = this.svg("g");
      this.attrs(A, {
...
const Cn = (e) => e.strings === void 0, En = {}, Nn = (e, t = En) => e._$AH = t;
const Re = mi(class extends fi {
  ...
  update(e, [t]) {
    ...
    } else if (e.type === Ne.ATTRIBUTE && i.getAttribute(r) === t + "") return re;
    return Nn(e), t;
  }
});
var Pn = Object.defineProperty, Rn = Object.getOwnPropertyDescriptor, Ye = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Rn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
...
], zn = /* @__PURE__ */ new Set(["sensor", "input_select", "select"]);
function Tn(e) {
  return e.split(".", 1)[0] ?? "";
}
function vt(e) {
...
var In = Object.defineProperty, Ln = Object.getOwnPropertyDescriptor, Z = (e, t, i, r) => {
...
let B = class extends O {
  ...
  captureCalibration(e) {
    ...
    const c = qn(t), d = xt((e[0] - c.minX) / (c.maxX - c.minX || 1)), p = xt((e[1] - c.minY) / (c.maxY - c.minY || 1));
...
var Wn = Object.defineProperty, Gn = Object.getOwnPropertyDescriptor, Nr = (e, t, i, r) => {
...
var Xn = Object.defineProperty, Yn = Object.getOwnPropertyDescriptor, Pr = (e, t, i, r) => {
...
const Le = 1e3, rr = ["on", "open", "opened", "true"];
function or(e, t, i) {
  return Math.min(i, Math.max(t, e));
}
function ps(e) {
...
let W = class extends O {
  ...
  renderOpening(e) {
    const t = e.id === this.selectedId, i = e.point[0] * Le, r = e.point[1] * Le, o = (e.length ?? 0.055) * Le, n = (e.angle ?? 0) * Math.PI / 180, s = Math.cos(n) * o / 2, a = Math.sin(n) * o / 2;
  ...
  renderDraft() {
    ...
    const e = this.draftPoint[0] * Le, t = this.draftPoint[1] * Le, i = this.draftLength * Le, r = this.draftAngle * Math.PI / 180, o = Math.cos(r) * i / 2, n = Math.sin(r) * i / 2;
...
let ae = class extends O {
  ...
  renderGraphOverlay() {
    const e = this.edgeStatuses(), t = this.graphEdges.map((r, o) => {
      ...
      return R`
          <g transform=${`translate(${o * qe} ${n * qe})`}>
...
const Ns = { basic: 0, rooms: 1, presences: 2 }, sr = /* @__PURE__ */ Symbol("closed-editor-section");
...
function Ms(e) {
  return [e.id, e.area_id, e.name, ...e.aliases ?? []].filter((t) => typeof t == "string" && t.trim().length > 0).map(zr);
}
function Tr(e, t) {
  if (!t?.trim()) return;
  const i = zr(t);
...
function lr(e, t) {
  return Math.max(1, Math.round(It(e) ?? t));
}
function Ts(e) {
  const t = Math.max(0.05, It(e.max_height_m) ?? 0.75);
  return {
    ...
    maxHeight: t,
    releaseHeight: Math.max(t + 0.05, It(e.release_height_m) ?? t + 0.2),
...
function js(e, t) {
  ...
  const r = Ts(i), o = It(t.attributes[r.heightAttribute]);
...
const Is = ["unknown", "unavailable", "not_detected"], Ls = /* @__PURE__ */ new Set(["", "unknown", "unavailable", "none", "null"]);
function ie(e, t) {
...
function Fs(e, t, i, r, o, n) {
  ...
  if (t.coordinate_space === "room_meters") {
    const c = me(ie(i, a)), d = me(ie(i, l)), p = Tr(r, o ?? e.room_id);
...
function Ys(e, t) {
  const i = Lt(t), r = li(e.point, i), o = li(Dr(e), i), n = e.target && e.target === et(t) ? Us : 0;
...
function Qs(e, t = Date.now()) {
  ...
  const i = e.filter((a) => (a.type ?? "person") === "person" && a.visible !== !1 && Lt(a) && et(a)), r = new Set(i), o = e.filter((a) => !r.has(a)), n = /* @__PURE__ */ new Map();
  for (const a of i) {
  ...
  for (const a of n.values()) {
    ...
    for (const g of h) {
      ...
      const S = y[0], w = y[1], k = S.distance <= Ks || li(Dr(m), Lt(S.candidate)) <= Ws, E = !!w && w.score - S.score < Xs;
...
let Ue = class extends O {
  ...
  render() {
    ...
    return u`${this.renderCastleSurround(s)}<ha-card
      class=${`${n ? "enchanted" : "classic"}${S ? " moonlight" : ""}${N ? " sunlight" : ""}${A ? " partly-cloudy" : ""}${E ? " has-clouds" : ""}${h ? g ? " occupied" : " empty-house" : ""}${m && w !== "clear" ? ` weather-${w}` : ""}${m ? ` state-${y}` : ""}${d === "armed" ? " alarm-armed" : ""}${d === "triggered" ? " alarm-triggered" : ""}${this.preview ? " preview" : ""}`}
      style=${`--moon-intensity:${a};--alarm-intensity:${p};--occupancy-intensity:${b};--weather-intensity:${k}`}
      ><header>
        <div>
          <span
            >${d === "triggered" ? "⚠ Alarm Triggered" : d === "armed" ? "✦ Map Secured" : y === "partlycloudy" ? S ? "☾ Partly Clouded Map" : "☀ Partly Clouded Map" : y === "clear-night" ? "☾ Clear Night Map" : w === "exceptional" ? "⚠ Exceptional Weather" : w === "wind" ? "➳ Wind over the Map" : w === "storm" ? "⛈ Storm over the Map" : w === "rain" ? "☂ Rain over the Map" : w === "snow" ? "❄ Snow over the Map" : w === "fog" ? "◇ Mist over the Map" : w === "cloudy" ? "☁ Clouded Map" : N ? "☀ Sunlit Map" : h && g ? "✦ Someone is Home" : h ? "◇ Empty House" : S ? "Moonlight Explorer" : n ? "Enchanted Explorer" : "Explorer map"}</span
          >
          <h1>${this.config.title}</h1>
        </div>
        <small>Enchanted Atmosphere · v${jr}</small>
      </header>
      <div class="map-stage">
...
console.info(
  `%c HOME ASSISTANT EXPLORER %c v${jr} `,
