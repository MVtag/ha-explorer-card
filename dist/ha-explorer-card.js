const At = globalThis, ci = At.ShadowRoot && (At.ShadyCSS === void 0 || At.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, di = /* @__PURE__ */ Symbol(), Ci = /* @__PURE__ */ new WeakMap();
let ur = class {
  constructor(t, i, r) {
  ...
  get styleSheet() {
    ...
    if (ci && t === void 0) {
      ...
      r && (t = Ci.get(i)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), r && Ci.set(i, t));
    }
    return t;
  }
  toString() {
...
}, Ei = ci ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
  for (const r of t.cssRules) i += r.cssText;
  return Fr(i);
})(e) : e;
const { is: Vr, defineProperty: Kr, getOwnPropertyDescriptor: Wr, getOwnPropertyNames: Gr, getOwnPropertySymbols: Ur, getPrototypeOf: Xr } = Object, Lt = globalThis, Pi = Lt.trustedTypes, Yr = Pi ? Pi.emptyScript : "", Qr = Lt.reactiveElementPolyfillSupport, $e = (e, t) => e, Et = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Yr : null;
      break;
  ...
  return i;
} }, pi = (e, t) => !Vr(e, t), Ni = { attribute: !0, type: String, converter: Et, reflect: !1, useDefault: !1, hasChanged: pi };
...
let Be = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, i, r) {
    const { get: o, set: n } = Wr(this.prototype, t) ?? { get() {
      return this[i];
    }, set(s) {
      this[i] = s;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty($e("properties"))) {
      const i = this.properties, r = [...Gr(i), ...Ur(i)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of r) i.unshift(Ei(o));
    } else t !== void 0 && i.push(Ei(t));
    return i;
  }
  static _$Eu(t, i) {
    const r = i.attribute;
  ...
  _$ET(t, i) {
    ...
    if (o !== void 0 && r.reflect === !0) {
      const n = (r.converter?.toAttribute !== void 0 ? r.converter : Et).toAttribute(i, r.type);
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const n = r.getPropertyOptions(o), s = typeof n.converter == "function" ? { fromAttribute: n.converter } : n.converter?.fromAttribute !== void 0 ? n.converter : Et;
      this._$Em = o;
  ...
  requestUpdate(t, i, r, o = !1, n) {
    if (t !== void 0) {
      ...
      if (o === !1 && (n = this[t]), r ??= s.getPropertyOptions(t), !((r.hasChanged ?? pi)(n, i) || r.useDefault && r.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(s._$Eu(t, r)))) return;
      this.C(t, i, r);
    }
...
Be.elementStyles = [], Be.shadowRootOptions = { mode: "open" }, Be[$e("elementProperties")] = /* @__PURE__ */ new Map(), Be[$e("finalized")] = /* @__PURE__ */ new Map(), Qr?.({ ReactiveElement: Be }), (Lt.reactiveElementVersions ??= []).push("2.1.2");
const hi = globalThis, Ri = (e) => e, Pt = hi.trustedTypes, Mi = Pt ? Pt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, gr = "$lit$", ke = `lit$${Math.random().toFixed(9).slice(2)}$`, mr = "?" + ke, Jr = `<${mr}>`, Me = document, tt = () => Me.createComment(""), it = (e) => e === null || typeof e != "object" && typeof e != "function", ui = Array.isArray, $r = (e) => ui(e) || typeof e?.[Symbol.iterator] == "function", Ft = `[ 	
\f\r]`, Je = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ti = /-->/g, zi = />/g, Ee = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Di = /'/g, Ii = /"/g, fr = /^(?:script|style|textarea|title)$/i, br = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), u = br(1), R = br(2), re = /* @__PURE__ */ Symbol.for("lit-noChange"), f = /* @__PURE__ */ Symbol.for("lit-nothing"), ji = /* @__PURE__ */ new WeakMap(), Ne = Me.createTreeWalker(Me, 129);
function yr(e, t) {
...
const _r = (e, t) => {
  ...
  for (let a = 0; a < i; a++) {
    const l = e[a];
    let c, d, p = -1, h = 0;
    for (; h < l.length && (s.lastIndex = h, d = s.exec(l), d !== null); ) h = s.lastIndex, s === Je ? d[1] === "!--" ? s = Ti : d[1] !== void 0 ? s = zi : d[2] !== void 0 ? (fr.test(d[2]) && (o = RegExp("</" + d[2], "g")), s = Ee) : d[3] !== void 0 && (s = Ee) : s === Ee ? d[0] === ">" ? (s = o ?? Je, p = -1) : d[1] === void 0 ? p = -2 : (p = s.lastIndex - d[2].length, c = d[1], s = d[3] === void 0 ? Ee : d[3] === '"' ? Ii : Di) : s === Ii || s === Di ? s = Ee : s === Ti || s === zi ? s = Je : (s = Ee, o = void 0);
    const g = s === Ee && e[a + 1].startsWith("/>") ? " " : "";
    n += s === Je ? l + Jr : p >= 0 ? (r.push(c), l.slice(0, p) + gr + l.slice(p) + ke + g) : l + ke + (p === -2 ? a : g);
  }
  return [yr(e, n + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class rt {
  constructor({ strings: t, _$litType$: i }, r) {
    ...
    this.parts = [];
    let n = 0, s = 0;
    const a = t.length - 1, l = this.parts, [c, d] = _r(t, i);
    ...
    for (; (o = Ne.nextNode()) !== null && l.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const p of o.getAttributeNames()) if (p.endsWith(gr)) {
          const h = d[s++], g = o.getAttribute(p).split(ke), b = /([.?@])?(.*)/.exec(h);
          l.push({ type: 1, index: n, name: b[2], strings: g, ctor: b[1] === "." ? to : b[1] === "?" ? io : b[1] === "@" ? ro : Ot }), o.removeAttribute(p);
      ...
      } else if (o.nodeType === 8) if (o.data === mr) l.push({ type: 2, index: n });
      else {
        let p = -1;
...
class eo {
  ...
  u(t) {
    ...
    Ne.currentNode = o;
    let n = Ne.nextNode(), s = 0, a = 0, l = r[0];
    for (; l !== void 0; ) {
      if (s === l.index) {
        let c;
        l.type === 2 ? c = new pt(n, n.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (c = new oo(n, this, t)), this._$AV.push(c), l = r[++a];
      }
      s !== l?.index && (n = Ne.nextNode(), s++);
    }
    return Ne.currentNode = Me, o;
  }
  p(t) {
    let i = 0;
...
class pt {
  ...
  _$AI(t, i = this) {
    t = Ze(this, t, i), it(t) ? t === f || t == null || t === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : t !== this._$AH && t !== re && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $r(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: i, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = rt.createElement(yr(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === o) this._$AH.p(i);
    else {
      const n = new eo(o, this), s = n.u(this.options);
      n.p(i), this.T(s), this._$AH = n;
    }
  }
  _$AC(t) {
    let i = ji.get(t.strings);
    return i === void 0 && ji.set(t.strings, i = new rt(t)), i;
  }
  k(t) {
    ui(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let r, o = 0;
    for (const n of t) o === i.length ? i.push(r = new pt(this.O(tt()), this.O(tt()), this, this.options)) : r = i[o], r._$AI(n), o++;
    o < i.length && (this._$AR(r && r._$AB.nextSibling, o), i.length = o);
  }
  _$AR(t = this._$AA.nextSibling, i) {
    for (this._$AP?.(!1, !0, i); t !== this._$AB; ) {
      const r = Ri(t).nextSibling;
      Ri(t).remove(), t = r;
    }
  }
  setConnected(t) {
...
class Ot {
  ...
  _$AI(t, i = this, r, o) {
    ...
    let s = !1;
    if (n === void 0) t = Ze(this, t, i, 0), s = !it(t) || t !== this._$AH && t !== re, s && (this._$AH = t);
    else {
      const a = t;
      let l, c;
      for (t = n[0], l = 0; l < n.length - 1; l++) c = Ze(this, a[r + l], i, l), c === re && (c = this._$AH[l]), s ||= !it(c) || c !== this._$AH[l], c === f ? t = f : t !== f && (t += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    s && !o && this.j(t);
  }
  j(t) {
...
class ro extends Ot {
  ...
  _$AI(t, i = this) {
    if ((t = Ze(this, t, i, 0) ?? f) === re) return;
...
const no = hi.litHtmlPolyfillSupport;
no?.(rt, pt), (hi.litHtmlVersions ??= []).push("3.3.3");
const so = (e, t, i) => {
  const r = i?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const n = i?.renderBefore ?? null;
    r._$litPart$ = o = new pt(t.insertBefore(tt(), n), n, void 0, i ?? {});
  }
  return o._$AI(e), o;
};
const gi = globalThis;
let O = class extends Be {
  ...
  update(t) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = so(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
O._$litElement$ = !0, O.finalized = !0, gi.litElementHydrateSupport?.({ LitElement: O });
const ao = gi.litElementPolyfillSupport;
ao?.({ LitElement: O });
...
const lo = { attribute: !0, type: String, converter: Et, reflect: !1, hasChanged: pi }, co = (e = lo, t, i) => {
...
function C(e) {
  return (t, i) => typeof i == "object" ? co(e, t, i) : ((r, o, n) => {
...
const po = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
function ho(e, t) {
  return (i, r, o) => {
...
let oi = class extends fi {
  constructor(t) {
    if (super(t), this.it = f, t.type !== Pe.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
ni.directiveName = "unsafeSVG", ni.resultType = 2;
const mo = mi(ni), fo = {
  light: ["on"],
  motion: ["on"],
  media: ["playing", "on"],
...
}, bo = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function vr(e) {
...
function yo(e) {
  ...
  return t.length ? [...new Set(t)] : St(e.kind);
}
function _e(e, t) {
  const i = t?.position;
...
function vo(e) {
  ...
  return typeof t != "number" || !Number.isFinite(t) ? 1 : vr(t / 255);
}
function qi(e) {
  const t = e.intensity;
  return typeof t != "number" || !Number.isFinite(t) ? 1 : vr(t);
}
function Li(e) {
...
function xr(e, t, i) {
  ...
  if (e.kind === "temperature") {
    ...
    return Number.isFinite(c) ? { index: t, reaction: e, active: !0, currentState: n.state, activeStates: o, intensity: 1, numericValue: c, unit: Li(n.attributes) } : { index: t, reaction: e, active: !1, currentState: n.state, activeStates: o, intensity: 0, unit: Li(n.attributes), reason: "state_inactive" };
  }
  const s = n.state.trim().toLowerCase(), a = o.map((c) => c.toLowerCase()).includes(s);
  let l = 0;
  return a && (e.kind === "light" ? l = vo(n.attributes) * qi(e) : l = qi(e)), {
    index: t,
    reaction: e,
    active: a,
...
function Nt(e, t) {
  return (e.reactions ?? []).map((i, r) => xr(i, r, t));
}
var xo = Object.defineProperty, wo = Object.getOwnPropertyDescriptor, De = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? wo(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && xo(t, i, o), o;
};
function ko(e) {
  const t = e?.trim();
  if (t) {
...
let be = class extends O {
  ...
  get statuses() {
    return this.room ? Nt(this.room, (e) => {
    ...
    return u`
      <article class=${`entity ${e.active ? "active" : "inactive"}`}>
        <button class="entity-main" @click=${() => this.openMoreInfo(t)}>
          <span class=${`entity-icon ${i}`}>${Ao[i]}</span>
          <span class="entity-copy">
            <strong>${this.entityName(t)}</strong>
            <small>${So[i]} · ${this.statusText(e)}</small>
          </span>
        </button>
        ${i === "light" ? u`<button
              class="action"
...
var Eo = Object.defineProperty, Po = Object.getOwnPropertyDescriptor, Y = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Po(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Eo(t, i, o), o;
};
const Bi = { width: 16, height: 9, status: "idle" }, No = { person: "●", pet: "◆", robot: "■", vehicle: "▰", object: "✦" }, Ro = "script,foreignObject,iframe,object,embed,link,meta,audio,video,canvas";
function Hi(e) {
  try {
...
function Mo(e) {
  ...
  return t?.length === 4 && t.every(Number.isFinite) && t[2] > 0 && t[3] > 0 ? { width: t[2], height: t[3] } : { width: Fi(e.getAttribute("width")) ?? 16, height: Fi(e.getAttribute("height")) ?? 9 };
}
function Zi(e) {
...
function Do(e) {
  ...
  i.querySelectorAll(Ro).forEach((o) => o.remove());
  ...
  return i.querySelectorAll("style").forEach((o) => {
    const n = Zi(o.textContent ?? "").trim();
    n ? o.textContent = n : o.remove();
  }), i.hasAttribute("xmlns") || i.setAttribute("xmlns", "http://www.w3.org/2000/svg"), i;
}
let V = class extends O {
  constructor() {
    super(...arguments), this.image = "", this.rooms = [], this.presences = [], this.minZoom = 1, this.maxZoom = 6, this.initialZoom = 1, this.fitMode = "contain", this.viewport = { zoom: 1, x: 0, y: 0 }, this.metadata = { ...Bi }, this.imageSource = "", this.svgMarkup = "", this.loadError = "", this.activePointers = /* @__PURE__ */ new Map(), this.imageRequest = 0, this.pointerMoved = !1;
  }
  connectedCallback() {
    super.connectedCallback(), this.resetViewport();
  }
  disconnectedCallback() {
    this.imageRequest += 1, this.floorplanAbort?.abort(), this.floorplanAbort = void 0, this.activePointers.clear(), this.pointerMoved = !1, super.disconnectedCallback();
  }
  updated(e) {
    e.has("rooms") && this.selectedRoom && (this.selectedRoom = this.rooms.find((t) => t.id === this.selectedRoom?.id)), (e.has("image") || e.has("fitMode") && this.image && Hi(this.image)) && this.loadFloorplan();
  }
  async loadFloorplan() {
    const e = ++this.imageRequest;
    if (this.floorplanAbort?.abort(), this.floorplanAbort = void 0, this.imageSource = "", this.svgMarkup = "", this.loadError = "", !this.image) {
      this.metadata = { ...Bi }, this.resetViewport();
      return;
    }
    ...
    try {
      if (Hi(this.image)) {
        ...
        this.floorplanAbort = t, await this.loadSvgFloorplan(e, t.signal);
      } else await this.loadRasterFloorplan(e);
    } catch (t) {
      ...
      e === this.imageRequest && (this.floorplanAbort = void 0);
    }
  }
  async loadSvgFloorplan(e, t) {
    const i = await fetch(this.image, { credentials: "same-origin", cache: "no-store", signal: t });
    if (!i.ok) throw new Error(`SVG-filen kunne ikke hentes (${i.status}).`);
    const r = await i.text();
    if (e !== this.imageRequest) return;
    const o = new DOMParser().parseFromString(r, "image/svg+xml"), n = Do(o), s = Mo(n);
    n.hasAttribute("viewBox") || n.setAttribute("viewBox", `0 0 ${s.width} ${s.height}`), n.setAttribute("x", "0"), n.setAttribute("y", "0"), n.setAttribute("width", String(x)), n.setAttribute("height", String(x)), n.setAttribute("preserveAspectRatio", this.fitMode === "cover" ? "xMidYMid slice" : "xMidYMid meet"), n.setAttribute("class", "inline-floorplan");
    const a = new XMLSerializer().serializeToString(n);
    e === this.imageRequest && (this.svgMarkup = a, this.metadata = { width: s.width, height: s.height, status: "loaded" }, this.resetViewport());
  }
  ...
  resetViewport() {
    this.viewport = { zoom: Zt(this.initialZoom, this.minZoom, this.maxZoom), x: 0, y: 0 };
  }
  toViewBoxPoint(e) {
  ...
  handleWheel(e) {
    e.preventDefault();
    const t = this.toViewBoxPoint(e), i = e.deltaY < 0 ? 1.12 : 1 / 1.12, r = Zt(this.viewport.zoom * i, this.minZoom, this.maxZoom);
    this.viewport = Ct(Oi(this.viewport, r, t.x, t.y), this.minZoom);
  }
  handlePointerDown(e) {
    this.activePointers.size || (this.pointerMoved = !1), this.activePointers.set(e.pointerId, { x: e.clientX, y: e.clientY }), e.currentTarget.setPointerCapture(e.pointerId);
  }
  handleInteractivePointerDown(e) {
    e.stopPropagation(), this.handlePointerDown(e);
  }
  handlePointerMove(e) {
    ...
    if ((Math.hypot(o.x - t.x, o.y - t.y) > 4 || n) && (this.pointerMoved = !0), n) {
      const s = Math.hypot(t.x - n.x, t.y - n.y), a = Math.hypot(o.x - n.x, o.y - n.y);
      if (s > 0) {
        const l = { x: (t.x + n.x) / 2, y: (t.y + n.y) / 2 }, c = { x: (o.x + n.x) / 2, y: (o.y + n.y) / 2 }, d = { x: (l.x - r.left) / r.width * x, y: (l.y - r.top) / r.height * x }, p = Zt(this.viewport.zoom * (a / s), this.minZoom, this.maxZoom), h = (c.x - l.x) / r.width * x, g = (c.y - l.y) / r.height * x, b = Oi(this.viewport, p, d.x, d.y);
        this.viewport = Ct({ ...b, x: b.x + h, y: b.y + g }, this.minZoom);
      }
    } else if (this.viewport.zoom > this.minZoom + 1e-4) {
      const s = (o.x - t.x) / r.width * x, a = (o.y - t.y) / r.height * x;
      this.viewport = Ct({ ...this.viewport, x: this.viewport.x + s, y: this.viewport.y + a }, this.minZoom);
    }
  ...
  selectRoom(e, t) {
    e.stopPropagation(), !this.pointerMoved && (this.selectedRoom = this.selectedRoom?.id === t.id ? void 0 : t, this.selectedRoom && (this.selectedPresence = void 0));
  }
  selectPresence(e, t) {
    e.stopPropagation(), !this.pointerMoved && (this.selectedPresence = this.selectedPresence?.id === t.id ? void 0 : t, this.selectedPresence && (this.selectedRoom = void 0));
  }
  handleCanvasClick() {
    this.pointerMoved || (this.selectedRoom = void 0, this.selectedPresence = void 0);
  }
  renderRooms() {
...
function qo(e) {
  return wr(e.condition?.allowed_states);
}
function Ve(e, t) {
  if (!e.state_binding)
    return {
  ...
  const i = e.state_binding.entity?.trim(), r = wr(e.state_binding.open_states);
  if (!i)
    return {
      nodeId: e.id,
      conditional: !0,
...
function Lo(e, t, i) {
  ...
  const r = e.condition.entity?.trim(), o = qo(e);
  if (!r)
    return {
      index: t,
      edge: e,
...
function ht(e, t) {
  ...
  return (e.route_graph_edges ?? []).map((r, o) => {
    const n = Lo(r, o, t), a = [r.from, r.to].filter((h) => h.kind === "node").map((h) => i.get(h.id)).filter((h) => !!h).map((h) => Ve(h, t)).filter((h) => h.conditional), c = a.find((h) => !h.active) ?? (n.conditional ? void 0 : a[0]), d = n.active && a.every((h) => h.active), p = n.conditional || a.length > 0;
    return c ? {
      ...n,
      conditional: p,
      active: d,
...
function Vi(e, t, i, r, o, n) {
  ...
  if (!s || !a) return;
  const l = kr(t), d = (o ? [...l].reverse() : l).map((h, g) => Oo(e, h, g)).filter((h) => !!h), p = [
    {
      kind: "room",
      id: i,
      key: `room:${i}`,
...
function Ho(e, t, i, r, o) {
  if (!(e.route_graph_edges ?? []).length) return;
  const n = `room:${t}`, s = `room:${i}`, { adjacency: a, endpoints: l } = Bo(e, r);
  ...
  h.reverse();
  const b = h.map((m) => l.get(m)).map((m) => m ? jo(e, m) : void 0).filter((m) => !!m);
  if (!(b.length < 2))
    return {
      source: "graph",
      hops: b,
...
function yi(e, t, i, r) {
  if (!t || !i || t === i) return;
  const o = ht(e, r), n = o.filter((h) => !h.active), s = (e.routes ?? []).find(
    (h) => h.from === t && h.to === i
  );
  if (s) return Vi(e, s, t, i, !1, n);
  const a = (e.routes ?? []).find(
    (h) => h.from === i && h.to === t
  );
  if (a) return Vi(e, a, t, i, !0, n);
  const l = Ho(e, t, i, o, n);
  if (l) return l;
...
function Ki(e, t) {
  ...
  i.forEach((A) => {
    const N = fe(A.from), M = fe(A.to), j = Fo(A);
    N === M && (n += 1), s.has(j) && (o += 1), s.add(j);
    const G = Rt(e, A.from), J = Rt(e, A.to);
    if (!G || !J || N === M) {
      r += 1;
      return;
    }
  ...
  const S = ht(e, t), w = S.filter((A) => !A.active), k = (e.route_nodes ?? []).map((A) => Ve(A, t)).filter((A) => A.conditional), E = k.filter((A) => !A.active), P = /* @__PURE__ */ new Set();
  return S.forEach((A) => {
...
var Zo = Object.defineProperty, Vo = Object.getOwnPropertyDescriptor, Bt = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Vo(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Zo(t, i, o), o;
};
const Vt = 900, Wi = 3600, Gi = 58, F = "http://www.w3.org/2000/svg";
let Ke = class extends V {
  constructor() {
    super(...arguments), this.routes = [], this.routeNodes = [], this.routeGraphEdges = [], this.previousPresencePositions = /* @__PURE__ */ new Map(), this.previousPresenceRooms = /* @__PURE__ */ new Map(), this.activeAnimations = /* @__PURE__ */ new Map(), this.transientTimers = /* @__PURE__ */ new Set();
  }
  disconnectedCallback() {
    this.transientTimers.forEach((e) => window.clearTimeout(e)), this.transientTimers.clear(), this.activeAnimations.forEach((e) => e.remove()), this.activeAnimations.clear(), this.previousPresencePositions.clear(), this.previousPresenceRooms.clear(), this.renderRoot.querySelectorAll("g.footsteps-scene > *").forEach((e) => e.remove()), super.disconnectedCallback();
  }
  scheduleTransientTask(e, t) {
    const i = window.setTimeout(() => {
      this.transientTimers.delete(i), this.isConnected && e();
    }, t);
    this.transientTimers.add(i);
  }
  updated(e) {
    ...
    t.forEach((n, s) => {
      ...
      if (o.add(n.id), this.activeAnimations.get(n.id)?.remove(), this.activeAnimations.delete(n.id), !r && c && (Math.abs(c.x - l.x) > 0.01 || Math.abs(c.y - l.y) > 0.01)) {
        ...
        g.setAttribute("attributeName", "transform"), g.setAttribute("attributeType", "XML"), g.setAttribute("type", "translate"), g.setAttribute("values", h.map((b) => `${b.x} ${b.y}`).join(";")), g.setAttribute("keyTimes", this.buildKeyTimes(h).join(";")), g.setAttribute("dur", `${Vt}ms`), g.setAttribute("begin", "indefinite"), g.setAttribute("fill", "freeze"), g.setAttribute("calcMode", "linear"), a.appendChild(g), this.activeAnimations.set(n.id, g), g.beginElement(), this.scheduleTransientTask(() => {
  ...
  createFootsteps(e) {
    ...
    if (r < Gi) return;
    const o = Math.min(20, Math.max(3, Math.floor(r / Gi)));
    for (let n = 0; n < o; n += 1) {
      ...
      const d = c.length > 0 ? (a - l) / c.length : 0, p = c.end.x - c.start.x, h = c.end.y - c.start.y, g = n % 2 === 0 ? -1 : 1, b = c.length > 0 ? -h / c.length : 0, m = c.length > 0 ? p / c.length : 0, y = 9 * g, S = c.start.x + p * d + b * y, w = c.start.y + h * d + m * y, k = Math.atan2(h, p) * 180 / Math.PI + 90, E = Math.round(s * Vt), P = document.createElementNS(F, "g");
      ...
      M.setAttribute("attributeName", "opacity"), M.setAttribute("values", "0;0.72;0.56;0"), M.setAttribute("keyTimes", "0;0.08;0.58;1"), M.setAttribute("begin", "indefinite"), M.setAttribute("dur", `${Wi}ms`), M.setAttribute("fill", "freeze"), P.append(A, N, M), t.appendChild(P), this.scheduleTransientTask(() => {
        P.isConnected && M.beginElement();
      }, E), this.scheduleTransientTask(() => P.remove(), E + Wi + 120);
    }
  }
};
Bt([
...
let Mt = class extends Ke {
  ...
  syncRoomReactionOverlay() {
    ...
    const t = this.rooms.flatMap((a) => Nt(a, (l) => this.entityState(l)).map((l) => ({ room: a, status: l })));
    if (!t.length) return;
...
var Go = Object.getOwnPropertyDescriptor, Uo = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Go(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = s(o) || o);
  return o;
};
const z = "http://www.w3.org/2000/svg", Kt = 3e4;
let nt = class extends Mt {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this.afterglowTimer !== void 0 && window.clearTimeout(this.afterglowTimer), this.afterglowTimer = void 0;
  }
  pointInPolygon(e, t) {
  ...
  activities(e) {
    ...
    return this.presences.filter((i) => i.visible !== !1 && (i.type ?? "person") === "person").forEach((i) => {
      ...
      const r = t.get(i.id) ?? 0, o = r > 0, n = e - (this.lastOccupiedAt.get(i.id) ?? -1 / 0), s = !o && n >= 0 && n < Kt, a = o ? Math.min(1, 0.72 + Math.max(0, r - 1) * 0.12) : s ? Math.max(0, 1 - n / Kt) : 0;
  ...
  scheduleAfterglowRefresh(e, t) {
    ...
    const i = e.filter((r) => r.afterglow).map((r) => Kt - (t - (this.lastOccupiedAt.get(r.room.id) ?? t)));
  ...
  roomTemperatures() {
    return this.rooms.flatMap((e) => {
      ...
      const t = Nt(e, (r) => this.atmosphereEntityState(r)).filter((r) => r.reaction.kind === "temperature" && r.active).map((r) => this.temperatureCelsius(r)).filter((r) => r !== void 0);
      if (!t.length) return [];
  ...
  syncTemperatureAtmosphere() {
    ...
    i.setAttribute("class", "room-temperature-atmosphere-scene"), i.setAttribute("aria-label", "Temperaturatmosfære i rum"), i.setAttribute("pointer-events", "none"), t.forEach(({ room: l, celsius: c }) => {
      const d = this.temperatureOpacity(c), p = this.atmosphereTemperatureColor(c), h = this.temperatureBand(c), g = document.createElementNS(z, "polygon");
      ...
      const b = document.createElementNS(z, "title"), m = new Intl.NumberFormat("da-DK", { maximumFractionDigits: 1 }).format(c);
  ...
  appendFireplaceAtmosphere(e, t, i, r, o) {
    const n = _e(t, i.reaction), s = Math.max(0.2, Math.min(1, i.intensity || 1)), a = i.reaction.radius, l = Number.isFinite(a) ? Math.max(42, Math.min(180, a * x)) : 82, c = document.createElementNS(z, "g");
    ...
    const d = document.createElementNS(z, "circle");
    ...
    const h = document.createElementNS(z, "ellipse");
    ...
    [
      ...
      const k = document.createElementNS(z, "circle");
      if (k.setAttribute("class", "fireplace-ember"), k.setAttribute("cx", String(m)), k.setAttribute("cy", String(y)), k.setAttribute("r", String(S)), k.setAttribute("fill", w % 2 === 0 ? "var(--explorer-fireplace-ember, #d96532)" : "var(--explorer-fireplace-atmosphere-core, #f0b65c)"), k.setAttribute("opacity", r ? String(0.28 + s * 0.22) : "0"), c.appendChild(k), !r) {
        ...
        const P = document.createElementNS(z, "animate");
  ...
  syncFireplaceAtmosphere() {
    ...
    const t = this.rooms.flatMap(
      (l) => Nt(l, (c) => this.atmosphereEntityState(c)).filter((c) => c.reaction.kind === "fireplace" && c.active).map((c) => ({ room: l, status: c }))
    );
    if (!t.length) return;
    const i = document.createElementNS(z, "g");
  ...
  appendOvercastCloud(e, t, i, r, o, n) {
    ...
    const c = document.createElementNS(z, "g");
    ...
    const d = document.createElementNS(z, "path");
    d.setAttribute("class", "overcast-cloud-base"), d.setAttribute("d", "M-150 31 C-133 1 -108 -17 -80 -18 C-66 -47 -41 -62 -13 -57 C5 -78 34 -82 58 -62 C84 -62 107 -48 120 -27 C146 -18 158 5 145 29 C128 53 99 63 66 61 C34 75 -4 74 -37 68 C-76 75 -116 64 -140 48 C-151 41 -155 35 -150 31 Z"), c.appendChild(d), [
      ...
      const w = document.createElementNS(z, "ellipse");
    ...
    const h = document.createElementNS(z, "path");
...
var Xo = Object.defineProperty, Yo = Object.getOwnPropertyDescriptor, ut = (e, t, i, r) => {
...
let ye = class extends nt {
  ...
  createSvg(e) {
    return document.createElementNS(Qo, e);
  }
  setAttributes(e, t) {
...
const Jo = ["on"], $o = /* @__PURE__ */ new Set(["unknown", "unavailable"]);
function _o(e) {
  const t = (e ?? []).map((i) => i.trim()).filter(Boolean);
  return t.length ? [...new Set(t)] : [...Jo];
}
function Ar(e, t) {
  const i = e.visible !== !1, r = e.state_binding, o = _o(r?.active_states);
  if (!i)
    return {
      zone: e,
      visible: !1,
...
function en(e, t) {
  return e.map((i) => Ar(i, t));
}
var tn = Object.defineProperty, rn = Object.getOwnPropertyDescriptor, Sr = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? rn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && tn(t, i, o), o;
};
const ue = "http://www.w3.org/2000/svg", on = {
...
let We = class extends ye {
  ...
  zoneColor(e) {
    return e.color?.trim() || on[e.kind ?? "info"];
  }
  appendZoneTitle(e, t) {
  ...
  renderZone(e, t, i) {
    ...
    if (p.setAttribute("text-anchor", "middle"), p.setAttribute("dominant-baseline", "central"), p.setAttribute("fill", n), p.setAttribute("font-size", "18"), p.setAttribute("font-weight", "900"), p.setAttribute("font-family", "system-ui, sans-serif"), p.textContent = nn[o], c.appendChild(p), s.appendChild(c), r.name) {
  ...
  syncZonesOverlay() {
    ...
    const i = en(this.zones, (c) => this.hass?.states[c]?.state).filter((c) => c.active && c.zone.points.length >= 3);
    if (!i.length) return;
...
var sn = Object.defineProperty, an = Object.getOwnPropertyDescriptor, vi = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? an(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && sn(t, i, o), o;
};
const ln = "http://www.w3.org/2000/svg", cn = 4200, dn = 900, pn = 54, hn = { person: "Person", pet: "Kæledyr", robot: "Robot", vehicle: "Køretøj", object: "Objekt" }, Ui = { person: [202, 344, 42, 158, 274, 18], pet: [28, 112, 326, 52, 178, 286], robot: [188, 218, 264, 164, 204, 238], vehicle: [12, 210, 38, 330, 186, 262], object: [272, 44, 154, 320, 196, 22] }, Wt = [58, 64, 54, 61, 56, 66], un = [8, 6, 10, 7, 9, 5], gn = [7, 4, 10, 6, 8, 3];
function Xi(e) {
  let t = 2166136261;
...
let Te = class extends We {
  constructor() {
    super(...arguments), this.movementHistory = {}, this.petRobotTrails = {}, this.polishPreviousPositions = /* @__PURE__ */ new Map(), this.polishPreviousRooms = /* @__PURE__ */ new Map(), this.movementHistorySamples = /* @__PURE__ */ new Map(), this.polishTrailTimers = /* @__PURE__ */ new Set();
  }
  updated(e) {
  ...
  disconnectedCallback() {
    this.movementHistoryTimer !== void 0 && window.clearTimeout(this.movementHistoryTimer), this.movementHistoryTimer = void 0, this.polishTrailTimers.forEach((e) => window.clearTimeout(e)), this.polishTrailTimers.clear(), this.polishPreviousPositions.clear(), this.polishPreviousRooms.clear(), this.movementHistorySamples.clear(), this.renderRoot.querySelector(":scope g.presence-trails-scene")?.replaceChildren(), super.disconnectedCallback();
  }
  polishScheduleTrailTask(e, t) {
    const i = window.setTimeout(() => {
      this.polishTrailTimers.delete(i), this.isConnected && e();
    }, t);
    this.polishTrailTimers.add(i);
  }
  polishPresenceColor(e) {
    const t = e.color?.trim();
    if (t) return t;
    const i = e.type ?? "person", r = Ui[i][Xi(e.id) % Ui[i].length];
  ...
  polishTrailDuration(e) {
    ...
    return Number.isFinite(t) ? Math.round(ft(t, 1, 60) * 1e3) : cn;
  }
  polishBasePosition(e) {
    return { x: (e.x ?? 0.5) * x, y: (e.y ?? 0.5) * x };
  }
  polishPersonTrailVariant(e) {
    return Xi(e.id) % Wt.length;
  }
  polishOffsets(e) {
    const t = /* @__PURE__ */ new Map();
    ...
    for (; i.size; ) {
      ...
      for (; a.length; ) {
        ...
        for (const h of [...i]) {
          ...
          Math.hypot(p.x - b.x, p.y - b.y) <= pn && (i.delete(h), s.push(g), a.push(g));
        }
      }
      if (s.length < 2) continue;
      const l = [...s].sort((d, p) => d.id.localeCompare(p.id)), c = Math.min(52, 24 + l.length * 4);
      l.forEach((d, p) => {
        const h = this.polishBasePosition(d), g = l.length === 2 ? p === 0 ? Math.PI : 0 : -Math.PI / 2 + Math.PI * 2 * p / l.length, b = ft(h.x + Math.cos(g) * c, 38, x - 38), m = ft(h.y + Math.sin(g) * c, 38, x - 64);
  ...
  polishCreateSvg(e) {
    return document.createElementNS(ln, e);
  }
  ...
  polishSyncPresenceVisuals() {
    ...
    e.forEach((r, o) => {
      ...
      d.textContent = `${r.name ?? r.id} · ${hn[s]}${h}${p}`, n.appendChild(d);
    });
  }
  polishRouteConfig() {
  ...
  polishMovementPath(e, t, i, r) {
    if (!i || !r || i === r) return [e, t];
    const o = yi(this.polishRouteConfig(), i, r, (n) => this.hass?.states[n]?.state);
  ...
  polishTrailSpacing(e, t = 0) {
    return e === "person" ? Wt[t] ?? Wt[0] : e === "pet" ? 46 : e === "robot" ? 42 : e === "vehicle" ? 54 : e === "object" ? 62 : 58;
  }
  ...
  polishCreateTrail(e, t) {
    ...
    for (let p = 0; p < d; p += 1) {
      ...
      const y = m.length > 0 ? (g - b) / m.length : 0, S = m.end.x - m.start.x, w = m.end.y - m.start.y, k = p % 2 === 0 ? -1 : 1, E = r === "person" ? un[o] ?? 8 : r === "pet" ? 6 : 0, P = r === "person" ? gn[o] ?? 7 : E ? 7 : 0, A = m.length > 0 ? -w / m.length : 0, N = m.length > 0 ? S / m.length : 0, M = m.start.x + S * y + A * E * k, j = m.start.y + w * y + N * E * k, G = Math.atan2(w, S) * 180 / Math.PI + 90, J = Math.round(h * dn), T = this.polishCreateSvg("g");
      T.setAttribute("class", `trail-mark trail-${r}${r === "person" ? ` trail-person-v${o + 1}` : ""}`), T.setAttribute("data-presence-id", t.id), r === "person" && T.setAttribute("data-trail-style", String(o + 1)), T.setAttribute("transform", `translate(${M} ${j}) rotate(${G + (E ? k * P : 0)})`), T.setAttribute("opacity", "0"), this.polishAppendTrailShape(T, r, n, o);
      const q = this.polishCreateSvg("animate");
      this.polishSetAttributes(q, { attributeName: "opacity", values: "0;0.78;0.54;0", keyTimes: "0;0.08;0.58;1", begin: "indefinite", dur: `${s}ms`, fill: "freeze" }), T.appendChild(q), i.appendChild(T), this.polishScheduleTrailTask(() => {
        T.isConnected && q.beginElement();
      }, J), this.polishScheduleTrailTask(() => T.remove(), J + s + 120);
    }
  }
  polishSyncTrails() {
    ...
    for (const [a, l] of this.movementHistorySamples) {
      ...
      for (let b = 1; b < l.length; b += 1) {
        ...
        for (let k = 1; k < S.length; k += 1) {
          const E = S[k - 1], P = S[k], A = P.x - E.x, N = P.y - E.y, M = Math.hypot(A, N), j = Math.atan2(N, A) * 180 / Math.PI;
          if (d === "robot") {
          ...
          const G = d === "pet" ? 52 : 70, J = Math.min(12, Math.max(1, Math.floor(M / G))), T = j + 90;
          for (let q = 1; q <= J; q += 1) {
            const H = q / (J + 1), U = q % 2 === 0 ? -1 : 1, Ie = M > 0 ? -N / M : 0, Ce = M > 0 ? A / M : 0, Qe = d === "pet" ? 7 : 6, $ = this.polishCreateSvg("g");
            $.setAttribute("class", `movement-history-mark trail-${d}${d === "person" ? ` trail-person-v${g + 1}` : ""}`), $.setAttribute("data-presence-id", a), $.setAttribute("transform", `translate(${E.x + A * H + Ie * Qe * U} ${E.y + N * H + Ce * Qe * U}) rotate(${T + U * 4}) scale(${d === "pet" ? 0.72 : 0.62})`), $.setAttribute("opacity", String(w)), this.polishAppendTrailShape($, d, h, g), o.appendChild($);
          }
        }
      }
    }
...
let st = class extends Te {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this.magicRefreshTimer !== void 0 && window.clearTimeout(this.magicRefreshTimer), this.magicRefreshTimer = void 0;
  }
  ...
  magicActivities(e) {
    ...
    return this.magicPreviousOccupiedRooms.clear(), i.forEach((r) => this.magicPreviousOccupiedRooms.add(r)), this.rooms.map((r) => {
      const o = t.get(r.id) ?? 0, n = o > 0, s = this.magicAfterglowStartedAt.get(r.id), a = s === void 0 ? 1 / 0 : e - s, l = !n && a >= 0 && a < Yi, c = n ? Math.min(1, 0.72 + Math.max(0, o - 1) * 0.12) : l ? Math.max(0, 1 - a / Yi) : 0;
  ...
  magicAppendRoom(e, t) {
    ...
    if (i.points.length < 3) return;
    const n = this.magicPolygonPoints(i), s = document.createElementNS(bt, "g");
    s.setAttribute("class", `room-magic ${r ? "active" : "afterglow"}`), s.setAttribute("data-room-id", i.id);
    const a = document.createElementNS(bt, "polygon");
    ...
    const l = document.createElementNS(bt, "polygon");
  ...
  magicSyncRoomAtmosphere() {
    ...
    const i = document.createElementNS(bt, "g");
...
var yn = Object.defineProperty, vn = Object.getOwnPropertyDescriptor, Cr = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? vn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && yn(t, i, o), o;
};
const _ = "http://www.w3.org/2000/svg", xn = ["on", "open", "opened", "true"], Gt = 600 * 1e3, Ut = 1800 * 1e3, Xt = 3600 * 1e3, Qi = 60 * 1e3, yt = (e) => e * Math.PI / 180;
let Ge = class extends st {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this.openingAgeTimer !== void 0 && window.clearTimeout(this.openingAgeTimer), this.openingAgeTimer = void 0;
  }
  isOpen(e) {
    const t = e.state_binding;
    if (!t) return !1;
    const i = this.hass?.states[t.entity]?.state?.toLowerCase();
    return i ? (t.open_states ?? xn).map((r) => r.toLowerCase()).includes(i) : !1;
  }
  ...
  openingAgeInfo(e, t, i = Date.now()) {
    ...
    if (r === void 0) return;
    const o = Math.max(0, i - r), n = Math.floor(o / 6e4), s = o >= Xt ? "alert" : o >= Ut ? "warning" : o >= Gt ? "watch" : "fresh", a = Math.floor(n / 60), l = n % 60, c = a > 0 ? `åben i ${a} t${l ? ` ${l} min` : ""}` : `åben i ${n} min`, d = s === "fresh" ? "" : a > 0 ? l ? `${a}t ${l}m` : `${a}t` : `${n}m`;
  ...
  scheduleOpeningAgeRefresh(e) {
    ...
    for (const i of this.openings.filter((r) => r.visible !== !1)) {
      ...
      const n = Math.max(0, e - o), s = n < Gt ? Gt : n < Ut ? Ut : n < Xt ? Xt : void 0, a = s === void 0 ? Qi : Math.max(1e3, s - n + 50);
      t = Math.min(t, Qi, a);
    }
  ...
  drawDoor(e, t, i) {
    const r = this.isOpen(t), o = this.openingAgeInfo(t, r, i), n = Math.max(28, (t.length ?? 0.055) * x), s = t.angle ?? 0, a = t.open_angle ?? 82, l = t.hinge ?? "start", c = t.swing ?? "left", d = t.point[0] * x, p = t.point[1] * x, h = n / 2, g = yt(s), b = Math.cos(g), m = Math.sin(g), y = -m, S = b, w = { x: d - b * h, y: p - m * h }, k = { x: d + b * h, y: p + m * h }, E = l === "start" ? w : k, P = l === "start" ? k : w, A = s + (l === "start" ? 0 : 180), N = (c === "left" ? -1 : 1) * (l === "start" ? 1 : -1), M = A + (r ? N * a : 0), j = yt(M), G = { x: E.x + Math.cos(j) * n, y: E.y + Math.sin(j) * n }, J = o ? ` open-age-${o.level}` : "", T = document.createElementNS(_, "g");
    T.setAttribute("class", `dynamic-opening door ${r ? "is-open" : "is-closed"}${J}`), T.setAttribute("data-opening-id", t.id), o && T.setAttribute("data-open-minutes", String(o.minutes)), this.line(T, w.x, w.y, k.x, k.y, "opening-gap");
    const q = Math.max(7, Math.min(12, n * 0.12));
    for (const $ of [w, k]) this.line(T, $.x - y * q / 2, $.y - S * q / 2, $.x + y * q / 2, $.y + S * q / 2, "door-jamb");
    r && this.line(T, E.x, E.y, P.x, P.y, "door-closed-guide"), this.line(T, E.x, E.y, G.x, G.y, "door-leaf");
    const H = document.createElementNS(_, "circle");
    if (H.setAttribute("cx", String(E.x)), H.setAttribute("cy", String(E.y)), H.setAttribute("r", "4.2"), H.setAttribute("class", "opening-hinge"), T.appendChild(H), r) {
      const $ = document.createElementNS(_, "path"), Ai = yt(A), Si = j, jr = E.x + Math.cos(Ai) * n, qr = E.y + Math.sin(Ai) * n, Lr = E.x + Math.cos(Si) * n, Or = E.y + Math.sin(Si) * n, Br = N > 0 ? 1 : 0, Hr = Math.abs(a) > 180 ? 1 : 0;
      $.setAttribute("d", `M ${jr} ${qr} A ${n} ${n} 0 ${Hr} ${Br} ${Lr} ${Or}`), $.setAttribute("class", "door-swing"), T.appendChild($);
    }
    const U = d + y * 14, Ie = p + S * 14, Ce = document.createElementNS(_, "circle");
    Ce.setAttribute("cx", String(U)), Ce.setAttribute("cy", String(Ie)), Ce.setAttribute("r", "5.2"), Ce.setAttribute("class", "opening-status-dot"), T.appendChild(Ce), this.appendAgeIndicator(T, U, Ie, o);
    const Qe = document.createElementNS(_, "title");
    Qe.textContent = `${t.name ?? t.id} · ${r ? "åben" : "lukket"}${o ? ` · ${o.description}` : ""}${t.state_binding ? ` · ${t.state_binding.entity}` : " · ingen entity"}`, T.appendChild(Qe), e.appendChild(T);
  }
  drawWindow(e, t, i) {
    const r = this.isOpen(t), o = this.openingAgeInfo(t, r, i), n = Math.max(26, (t.length ?? 0.05) * x), s = t.angle ?? 0, a = t.point[0] * x, l = t.point[1] * x, c = yt(s), d = Math.cos(c), p = Math.sin(c), h = -p, g = d, b = n / 2, m = 5.5, y = { x: a - d * b, y: l - p * b }, S = { x: a + d * b, y: l + p * b }, w = o ? ` open-age-${o.level}` : "", k = document.createElementNS(_, "g");
...
var wn = Object.defineProperty, kn = Object.getOwnPropertyDescriptor, Xe = (e, t, i, r) => {
...
let Se = class extends Ge {
  ...
  svg(e) {
    return document.createElementNS(An, e);
  }
  attrs(e, t) {
    Object.entries(t).forEach(([i, r]) => e.setAttribute(i, r));
  }
  createWeatherMask(e = this.weatherMaskId) {
    const t = this.svg("mask");
    this.attrs(t, {
      id: e,
    ...
    const i = this.svg("rect");
    this.attrs(i, { x: "0", y: "0", width: String(x), height: String(x), fill: "white" }), t.appendChild(i);
    for (const r of this.rooms) {
      if (r.points.length < 3) continue;
      const o = this.svg("polygon");
      this.attrs(o, {
        points: r.points.map(([n, s]) => `${n * x},${s * x}`).join(" "),
        fill: "black",
        stroke: "black",
        "stroke-width": "16",
  ...
  createCloudFilter(e = this.cloudFilterId) {
    const t = this.svg("filter");
    this.attrs(t, {
      id: e,
      x: "-55%",
      y: "-65%",
    ...
    const o = this.svg("feDisplacementMap");
    this.attrs(o, {
      in: "soft",
      in2: "noise",
      scale: "20",
  ...
  appendClouds(e, t = this.cloudFilterId) {
    ...
    this.weatherState === "cloudy" && i.push(
    ...
    for (const [a, l, c, d, p] of s) {
      ...
      this.attrs(j, {
        ...
        transform: o[d % o.length]
      }), m.appendChild(j), b.appendChild(m), e.appendChild(b);
    }
  }
  appendFog(e, t = "fog") {
    const i = [
...
Se.styles = I`
    ...
    .weather-outside-rooms-scene .weather-fog-bank { animation: explorerFogBank var(--fog-duration,22s) ease-in-out infinite alternate; animation-delay: var(--fog-delay,0s); }
    .weather-outside-rooms-scene .weather-fog-band { fill: none; stroke-linecap: round; }
    .weather-outside-rooms-scene .weather-fog-haze { stroke: #d4cdbc; stroke-width: 62; opacity: .22; filter: blur(20px); }
    .weather-outside-rooms-scene .weather-fog-wisp { stroke: #eee7d5; stroke-width: 19; opacity: .48; filter: blur(7px); animation: explorerFogWisp 15s ease-in-out infinite alternate-reverse; animation-delay: var(--fog-delay,0s); }
    .weather-outside-rooms-scene .weather-fog-depth-0 .weather-fog-haze { stroke-width: 74; opacity: .27; filter: blur(24px); }
    .weather-outside-rooms-scene .weather-fog-depth-0 .weather-fog-wisp { stroke-width: 23; opacity: .54; }
    .weather-outside-rooms-scene .weather-fog-depth-1 { opacity: .78; }
    .weather-outside-rooms-scene .weather-fog-depth-2 { opacity: .58; }
    .weather-outside-rooms-scene .weather-fog-depth-2 .weather-fog-haze { filter: blur(27px); }
    ...
    .weather-outside-rooms-scene .weather-wind-line { fill: none; stroke-linecap: round; stroke-linejoin: round; animation: explorerWindSweep var(--wind-duration,4.4s) cubic-bezier(.3,.02,.65,1) infinite; animation-delay: var(--wind-delay,0s); }
    ...
    .weather-outside-rooms-scene .weather-wind-line-1 { stroke-dasharray: 78 94 170 66; }
    .weather-outside-rooms-scene .weather-wind-line-2 { stroke-dasharray: 218 88 55 128; }
    .weather-outside-rooms-scene.state-windy-variant .weather-cloud-depth-0 .weather-cloud { animation-duration: 13s; }
    .weather-outside-rooms-scene.state-windy-variant .weather-cloud-depth-1 .weather-cloud { animation-duration: 20s; }
    .weather-outside-rooms-scene.state-windy-variant .weather-cloud-depth-2 .weather-cloud { animation-duration: 29s; }
    ...
    @keyframes explorerFogBank { from { transform: translate(-48px,-5px) scaleX(.98); opacity: .72; } 54% { opacity: 1; } to { transform: translate(58px,7px) scaleX(1.025); opacity: .82; } }
    @keyframes explorerFogWisp { from { transform: translateX(-18px); } to { transform: translateX(27px); } }
    ...
    @keyframes explorerWindSweep { 0% { stroke-dashoffset: 620; transform: translate(-92px,5px); } 48% { transform: translate(5px,-7px); } 100% { stroke-dashoffset: 0; transform: translate(112px,4px); } }
...
const Sn = {}, Er = mi(class extends fi {
  constructor() {
    super(...arguments), this.ot = Sn;
  }
  render(e, t) {
    return t();
  }
  update(e, [t, i]) {
    if (Array.isArray(t)) {
      if (Array.isArray(this.ot) && this.ot.length === t.length && t.every((r, o) => r === this.ot[o])) return re;
    } else if (this.ot === t) return re;
    return this.ot = Array.isArray(t) ? Array.from(t) : t, this.render(t, i);
  }
});
const Cn = (e) => e.strings === void 0, En = {}, Pn = (e, t = En) => e._$AH = t;
const Re = mi(class extends fi {
  constructor(e) {
    if (super(e), e.type !== Pe.PROPERTY && e.type !== Pe.ATTRIBUTE && e.type !== Pe.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
    if (!Cn(e)) throw Error("`live` bindings can only contain a single expression");
  }
  render(e) {
    return e;
  }
  update(e, [t]) {
    ...
    } else if (e.type === Pe.ATTRIBUTE && i.getAttribute(r) === t + "") return re;
    return Pn(e), t;
  }
});
var Nn = Object.defineProperty, Rn = Object.getOwnPropertyDescriptor, Ye = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Rn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Nn(t, i, o), o;
};
const Mn = [
...
], Tn = /* @__PURE__ */ new Set(["sensor", "input_select", "select"]);
function zn(e) {
  return e.split(".", 1)[0] ?? "";
}
function vt(e) {
...
let pe = class extends O {
  constructor() {
    super(...arguments), this.areas = [], this.areaError = "", this.loadingAreas = !1, this.areasLoaded = !1, this.entityCatalogSignature = "", this.entityCatalog = [], this.roomEntityCatalog = [];
  }
  setConfig(e) {
    this.config = e;
  }
  ...
  refreshEntityCatalog() {
    ...
    if (e === this.entityCatalogSource) return;
    this.entityCatalogSource = e;
    const t = Object.keys(e ?? {}), i = t.map((r) => `${r}\0${vt(e[r])}`).join("");
    i !== this.entityCatalogSignature && (this.entityCatalogSignature = i, this.entityCatalog = t.map((r) => e[r]).sort(
      (r, o) => vt(r).localeCompare(vt(o), "da")
    ), this.roomEntityCatalog = this.entityCatalog.filter(
      (r) => Tn.has(zn(r.entity_id))
    ));
  }
  renderEntityDatalist(e, t = !1) {
    const i = t ? this.roomEntityCatalog : this.entityCatalog;
    return Er([e, i], () => u`
      <datalist id=${e}>
        ${i.map(
      (r) => u`<option value=${r.entity_id}>${vt(r)}</option>`
    )}
      </datalist>
    `);
  }
...
var jn = Object.defineProperty, qn = Object.getOwnPropertyDescriptor, Z = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? qn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && jn(t, i, o), o;
};
const ne = 1e3, xt = (e) => Math.min(1, Math.max(0, e));
function Ji(e) {
...
let B = class extends O {
  ...
  mapPoint(e) {
    ...
    return t.width && t.height ? [xt((e.clientX - t.left) / t.width), xt((e.clientY - t.top) / t.height)] : [0.5, 0.5];
  }
  selectedPresence() {
  ...
  captureCalibration(e) {
    ...
    if (!n) return;
    const s = $i(n.attributes[o.x_attribute ?? "map_x"]), a = $i(n.attributes[o.y_attribute ?? "map_y"]), l = t.physical_meters;
    if (s === void 0 || a === void 0 || !l) return;
    const c = Ln(t), d = xt((e[0] - c.minX) / (c.maxX - c.minX || 1)), p = xt((e[1] - c.minY) / (c.maxY - c.minY || 1));
  ...
  finishPolygon() {
    if (!(this.pendingPoints.length < 3 || !this.roomConfig)) {
      if (this.drawingMode === "draw-new") {
        const e = this.draftRoomName.trim() || `Rum ${this.rooms.length + 1}`, t = this.uniqueRoomId(e), i = Ji(this.pendingPoints), r = this.meters(), o = { id: t, name: e, points: this.pendingPoints, presence_anchor: i, ...this.draftAreaId ? { area_id: this.draftAreaId } : {}, ...r ? { physical_meters: r } : {} };
  ...
  renderRoomPolygon(e) {
    if (!e.points.length) return f;
    const t = e.points.map(([n, s]) => `${n * ne},${s * ne}`).join(" "), i = e.id === this.selectedRoomId, r = Ji(e.points), o = i && this.drawingMode === "anchor" && this.pendingAnchor ? this.pendingAnchor : e.presence_anchor ?? r;
    return R`<g style=${this.drawingMode === "idle" ? "pointer-events:auto" : "pointer-events:none"} @click=${(n) => this.selectRoom(n, e.id)}><polygon points=${t} fill="var(--primary-color,#03a9f4)" fill-opacity=${i ? ".30" : ".14"} stroke="var(--primary-color,#03a9f4)" stroke-width=${i ? 7 : 4}/><text x=${r.x * ne} y=${r.y * ne} text-anchor="middle" dominant-baseline="middle">${e.name ?? e.id}</text>${i ? R`<circle cx=${o.x * ne} cy=${o.y * ne} r="15" class="anchor"/>` : f}</g>`;
  }
  renderPending() {
    if (!this.pendingPoints.length) return f;
    const e = this.pendingPoints.map(([t, i]) => `${t * ne},${i * ne}`).join(" ");
    return R`${this.pendingPoints.length >= 3 ? R`<polygon points=${e} class="pending-fill"/>` : f}<polyline points=${e} class="pending-line" fill="none"/>${this.pendingPoints.map(([t, i], r) => R`<circle cx=${t * ne} cy=${i * ne} r="13" class="pending-point"/><text x=${t * ne} y=${i * ne - 22} text-anchor="middle">${r + 1}</text>`)}`;
  }
  dimensionFields() {
...
function Fn(e, t) {
  const i = e.rooms ?? [], r = e.presences ?? [], o = e.zones ?? [], n = e.openings ?? [], s = e.route_nodes ?? [], a = e.route_graph_edges ?? [], l = e.routes ?? [], c = i.flatMap((w) => w.reactions ?? []), d = i.flatMap((w) => w.quick_actions ?? []), p = Hn(e), h = [];
  if (t)
    for (const w of p) {
...
var Zn = Object.defineProperty, Vn = Object.getOwnPropertyDescriptor, xi = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Vn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
...
let at = class extends O {
  ...
  renderItem(e) {
    return u`
      ...
      >
        ...
        <span class="state-label">${Kn[e.state]}</span>
  ...
  render() {
    if (!this.config) return f;
    const e = Fn(this.config, this.hass), t = e.attentionCount === 0, i = e.entityIssues.slice(0, 4);
    return u`
...
var Wn = Object.defineProperty, Gn = Object.getOwnPropertyDescriptor, Pr = (e, t, i, r) => {
...
let Tt = class extends O {
  ...
  render() {
    if (!this.config) return f;
    const e = Yt.find((a) => a[0] === this.theme) ?? Yt[0], t = this.dayNight, i = this.compass, r = this.alarm, o = this.occupancy, n = this.weather, s = this.config.appearance?.hide_source_text ?? !1;
    return u`
...
var Xn = Object.defineProperty, Yn = Object.getOwnPropertyDescriptor, Nr = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Yn(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Xn(t, i, o), o;
};
const _i = { person: "Person · skoaftryk", pet: "Kæledyr · poteaftryk", robot: "Robot · hjulspor", vehicle: "Køretøj · dobbelte hjulspor", object: "Objekt · magisk spor" };
...
var Qn = Object.defineProperty, Jn = Object.getOwnPropertyDescriptor, Rr = (e, t, i, r) => {
...
var $n = Object.defineProperty, _n = Object.getOwnPropertyDescriptor, Mr = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? _n(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && $n(t, i, o), o;
};
...
var es = Object.defineProperty, ts = Object.getOwnPropertyDescriptor, wi = (e, t, i, r) => {
...
let lt = class extends O {
  ...
  updateBinding(e, t) {
    ...
    i && this.updatePresence(e, { entity_binding: er({ ...i.entity_binding, ...t }) });
  }
  updateDetection(e, t) {
    const i = this.config?.presences?.[e];
    i && this.updatePresence(e, { shelly_pet_detection: er({ enabled: !0, height_attribute: "maxz", target_id_attribute: "target_id", timestamp_attribute: "timestamp", max_height_m: 0.75, release_height_m: 0.95, confirmation_updates: 3, release_updates: 2, ...i.shelly_pet_detection, ...t }) });
  }
  addRabbit() {
  ...
  entities() {
    return Object.values(this.hass?.states ?? {}).filter((e) => e.entity_id.startsWith("sensor.")).sort((e, t) => Qt(e).localeCompare(Qt(t), "da"));
  }
  render() {
    ...
    return u`<section class="panel"><div class="heading"><div><span class="eyebrow">Shelly Presence Gen4 · Pet Detection</span><h3>Find kaninen med radar</h3></div><button @click=${this.addRabbit}>+ Tilføj kanin</button></div>
      ...
      <datalist id="shelly-pet-entities">${this.entities().map((i) => u`<option value=${i.entity_id}>${Qt(i)}</option>`)}</datalist>
...
var is = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, ki = (e, t, i, r) => {
...
let ct = class extends O {
  ...
  updateBinding(e, t) {
    const i = this.config?.presences?.[e];
    i && this.updatePresence(e, { entity_binding: os({ ...i.entity_binding, ...t }) });
  }
  addPerson() {
    if (!this.config) return;
    const e = [...this.config.presences ?? []];
  ...
  datalist(e) {
    return u`<datalist id=${e}>${this.entities.map((t) => u`<option value=${t.entity_id}>${Jt(t)}</option>`)}</datalist>`;
  }
  render() {
...
var ns = Object.defineProperty, ss = Object.getOwnPropertyDescriptor, ce = (e, t, i, r) => {
...
let oe = class extends O {
  ...
  mapPoint(e) {
    ...
    return !i.width || !i.height ? [0.5, 0.5] : [
      ir((e.clientX - i.left) / i.width),
      ir((e.clientY - i.top) / i.height)
    ];
  }
  handleMapClick(e) {
  ...
  uniqueZoneId(e) {
    const t = as(e), i = new Set(this.zones.map((o) => o.id));
    if (!i.has(t)) return t;
    let r = 2;
    for (; i.has(`${t}_${r}`); ) r += 1;
    return `${t}_${r}`;
  ...
  zoneFromDraft(e, t) {
    ...
    return {
      ...
      ...i ? {
        state_binding: {
          entity: i,
          active_states: ls(this.draftStates)
        }
      } : {}
    };
  }
  ...
  statusText(e) {
    const t = Ar(e, (i) => this.hass?.states[i]?.state);
  ...
  renderZonePolygon(e) {
    ...
    return R`
      ...
      this.drawing || (r.stopPropagation(), this.selectZone(e));
        ...
        ${e.name ? R`<text x=${e.points.reduce((r, o) => r + o[0], 0) / e.points.length * xe} y=${e.points.reduce((r, o) => r + o[1], 0) / e.points.length * xe} text-anchor="middle">${e.name}</text>` : f}
      </g>
    `;
  }
  renderPending() {
    ...
    return R`
      ${this.pendingPoints.length >= 3 ? R`<polygon class="pending-fill" points=${e}></polygon>` : f}
      <polyline class="pending-line" points=${e}></polyline>
      ${this.pendingPoints.map(([t, i], r) => R`
      ...
      <div class="form-grid">
        ...
        <label>
          ...
          <select .value=${this.draftKind} @change=${(t) => this.draftKind = t.target.value}>
            ${tr.map((t) => u`<option value=${t.value}>${t.label}</option>`)}
          </select>
        </label>
        <label class="wide">
          ...
          <datalist id=${e}>
            ${this.entities.map((t) => u`<option value=${t.entity_id}>${$t(t)}</option>`)}
          </datalist>
        ...
        <div class="workspace">
          <div class="map-wrap">
            <svg viewBox="0 0 1000 1000" preserveAspectRatio="none" @click=${this.handleMapClick}>
              ...
              ${e ? R`<image href=${e} width="1000" height="1000" preserveAspectRatio="none" opacity=".72"></image>` : f}
              ...
              <div class="zone-list">
                ${this.zones.map((r) => u`
                  <button class=${r.id === this.selectedZoneId ? "zone-row selected" : "zone-row"} @click=${() => this.selectZone(r)}>
                    <span><strong>${r.name ?? r.id}</strong><small>${tr.find((o) => o.value === (r.kind ?? "info"))?.label}</small></span>
...
ce([
  v()
], oe.prototype, "selectedZoneId", 2);
ce([
  v()
], oe.prototype, "drawing", 2);
ce([
  v()
], oe.prototype, "pendingPoints", 2);
ce([
  v()
], oe.prototype, "draftName", 2);
ce([
  v()
], oe.prototype, "draftKind", 2);
ce([
  v()
], oe.prototype, "draftEntity", 2);
ce([
  v()
], oe.prototype, "draftStates", 2);
ce([
  v()
], oe.prototype, "draftVisible", 2);
oe = ce([
  D("ha-explorer-zones-editor")
], oe);
var cs = Object.defineProperty, ds = Object.getOwnPropertyDescriptor, Q = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? ds(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && cs(t, i, o), o;
};
const qe = 1e3, rr = ["on", "open", "opened", "true"];
function or(e, t, i) {
  return Math.min(i, Math.max(t, e));
}
function ps(e) {
...
let W = class extends O {
  ...
  get entities() {
    return Object.values(this.hass?.states ?? {}).filter((e) => e.entity_id.startsWith("binary_sensor.") || e.entity_id.startsWith("cover.") || e.entity_id.startsWith("input_boolean.") || e.entity_id.startsWith("sensor.")).sort((e, t) => _t(e).localeCompare(_t(t), "da"));
  }
  emitConfig(e) {
    this.dispatchEvent(new CustomEvent("config-changed", { detail: { config: e }, bubbles: !0, composed: !0 }));
  }
  uniqueId(e) {
    const t = ps(e), i = new Set(this.openings.map((o) => o.id));
    if (!i.has(t)) return t;
    let r = 2;
    for (; i.has(`${t}_${r}`); ) r++;
    return `${t}_${r}`;
  ...
  mapPoint(e) {
    const t = e.currentTarget.getBoundingClientRect();
    return !t.width || !t.height ? [0.5, 0.5] : [or((e.clientX - t.left) / t.width, 0, 1), or((e.clientY - t.top) / t.height, 0, 1)];
  }
  handleMapClick(e) {
  ...
  select(e) {
    this.selectedId = e.id, this.placing = !1, this.draftName = e.name ?? e.id, this.draftKind = e.kind, this.draftPoint = [...e.point], this.draftAngle = e.angle ?? 0, this.draftLength = e.length ?? (e.kind === "door" ? 0.055 : 0.05), this.draftHinge = e.hinge ?? "start", this.draftSwing = e.swing ?? "left", this.draftOpenAngle = e.open_angle ?? 82, this.draftEntity = e.state_binding?.entity ?? "", this.draftStates = (e.state_binding?.open_states ?? rr).join(", "), this.draftVisible = e.visible !== !1;
  }
  openingFromDraft(e) {
    const t = this.draftEntity.trim();
    return { id: e, name: this.draftName.trim() || e, kind: this.draftKind, point: this.draftPoint, angle: this.draftAngle, length: this.draftLength, hinge: this.draftHinge, swing: this.draftSwing, open_angle: this.draftOpenAngle, visible: this.draftVisible, ...t ? { state_binding: { entity: t, open_states: hs(this.draftStates) } } : {} };
  }
  save() {
    if (!this.config) return;
    if (this.selected) {
  ...
  stateText(e) {
    ...
    return t ? `${(e.state_binding.open_states ?? rr).map((r) => r.toLowerCase()).includes(t.toLowerCase()) ? "Åben" : "Lukket"} · ${t}` : "Entity mangler";
  }
  renderOpening(e) {
    ...
    return R`<g class=${t ? "opening selected" : "opening"} @click=${(l) => {
      this.placing || (l.stopPropagation(), this.select(e));
    }}><line x1=${i - s} y1=${r - a} x2=${i + s} y2=${r + a}></line><circle cx=${i} cy=${r} r=${t ? 11 : 8}></circle>${e.name ? R`<text x=${i} y=${r - 18} text-anchor="middle">${e.name}</text>` : f}</g>`;
  }
  renderDraft() {
    ...
    return R`<g class="opening draft"><line x1=${e - o} y1=${t - n} x2=${e + o} y2=${t + n}></line><circle cx=${e} cy=${t} r="11"></circle></g>`;
  }
  render() {
    if (!this.config) return f;
...
var us = Object.defineProperty, gs = Object.getOwnPropertyDescriptor, de = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? gs(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && us(t, i, o), o;
};
const ei = { light: "Lampe / lys", motion: "Bevægelsessensor", media: "TV / media", opening: "Dør / vindue", temperature: "Temperatur", fireplace: "Pejs / ildsted" }, ti = { light: "✦", motion: "◉", media: "▶", opening: "↗", temperature: "°", fireplace: "🔥" }, ii = (e) => Math.min(1, Math.max(0, e));
let te = class extends O {
  ...
  beginEdit(e) {
    ...
    !t || !i || (this.editingIndex = e, this.draftKind = i.kind, this.draftEntity = i.entity, this.draftStates = i.kind === "temperature" ? "" : (i.active_states?.length ? i.active_states : St(i.kind)).join(", "), this.draftPosition = _e(t, i), this.draftIntensity = i.intensity ?? 0.75, this.draftRadius = i.radius ?? 90);
  }
  cancelEdit() {
    this.editingIndex = void 0, this.draftKind = "light", this.draftEntity = "", this.draftStates = St("light").join(", "), this.draftPosition = void 0, this.draftIntensity = 0.75, this.draftRadius = 90;
  }
  removeReaction(e) {
    this.selectedRoom && (this.updateSelectedRoom((this.selectedRoom.reactions ?? []).filter((t, i) => i !== e)), this.editingIndex === e && this.cancelEdit());
  }
  changeKind(e) {
    this.draftKind = e, this.draftEntity = "", this.draftStates = e === "temperature" ? "" : St(e).join(", "), e === "fireplace" && (this.draftIntensity = 0.75, this.draftRadius = 90);
  }
  options() {
  ...
  handlePreviewClick(e) {
    ...
    !i.width || !i.height || (this.draftPosition = { x: ii((e.clientX - i.left) / i.width), y: ii((e.clientY - i.top) / i.height) });
  }
  preview(e) {
    ...
    return u`<div class="placement"><div><strong>Fysisk placering</strong><small>Klik på plantegningen dér hvor entity'en sidder.</small></div><div class="preview" @click=${this.handlePreviewClick}>${t ? u`<img src=${t} alt="">` : f}<svg viewBox="0 0 ${x} ${x}" preserveAspectRatio="none"><polygon points=${e.points.map(([r, o]) => `${r * x},${o * x}`).join(" ")}></polygon>${(e.reactions ?? []).map((r) => {
      const o = _e(e, r);
      return u`<g class="existing" transform=${`translate(${o.x * x} ${o.y * x})`}><circle r="13"></circle><text>${ti[r.kind]}</text></g>`;
    })}<g class="draft-point" transform=${`translate(${i.x * x} ${i.y * x})`}><circle r=${this.draftKind === "fireplace" ? "18" : "14"}></circle><text>${ti[this.draftKind]}</text></g></svg></div><small>${(i.x * 100).toFixed(1)} % / ${(i.y * 100).toFixed(1)} %</small></div>`;
  }
  statusLabel(e, t) {
    const i = xr(e, t, (r) => this.state(r));
...
var ms = Object.getOwnPropertyDescriptor, fs = (e, t, i, r) => {
...
var bs = Object.defineProperty, ys = Object.getOwnPropertyDescriptor, ve = (e, t, i, r) => {
...
var vs = Object.defineProperty, xs = Object.getOwnPropertyDescriptor, X = (e, t, i, r) => {
    ...
    return this.routeNodes.map((e) => {
      ...
      return R`
        ...
        >
          ...
          ${t > 0 ? R`<text class="usage" y="7" text-anchor="middle">${t}</text>` : f}
        </g>
      `;
    });
  }
...
var ws = Object.defineProperty, ks = Object.getOwnPropertyDescriptor, he = (e, t, i, r) => {
...
let ae = class extends O {
  ...
  renderGraphOverlay() {
    const e = this.edgeStatuses(), t = this.graphEdges.map((r, o) => {
      ...
      return R`
          <g transform=${`translate(${o * Le} ${n * Le})`}>
...
he([
  v()
], ae.prototype, "fromKey", 2);
he([
  v()
], ae.prototype, "toKey", 2);
he([
  v()
], ae.prototype, "conditionEntity", 2);
he([
  v()
], ae.prototype, "conditionStates", 2);
he([
  v()
], ae.prototype, "editingConditionIndex", 2);
he([
  v()
], ae.prototype, "editingEntity", 2);
he([
  v()
], ae.prototype, "editingStates", 2);
ae = he([
  D("ha-explorer-route-graph-editor")
], ae);
var As = Object.defineProperty, Ss = Object.getOwnPropertyDescriptor, gt = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Ss(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
...
let ze = class extends O {
  ...
  renderPreviewOverlay(e) {
    ...
    const t = e.hops.map((i) => `${i.point[0] * se},${i.point[1] * se}`).join(" ");
    return R`
      <polyline
        points=${t}
      ...
      ></polyline>
      ${e.hops.map((i, r) => R`
        <g transform=${`translate(${i.point[0] * se} ${i.point[1] * se})`}>
          <circle
  ...
  renderDisconnectedMarkers() {
    ...
    const e = Ki(
      ...
      return o ? R`
        <g transform=${`translate(${o[0] * se} ${o[1] * se})`}>
      ...
      return o ? R`
        <g transform=${`translate(${o.point[0] * se} ${o.point[1] * se})`}>
          <circle class="disconnected" r="20"></circle>
          <text class="warning-mark" text-anchor="middle" dominant-baseline="middle">!</text>
        </g>
      ` : f;
...
var Cs = Object.defineProperty, Es = Object.getOwnPropertyDescriptor, mt = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Es(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
  return r && o && Cs(t, i, o), o;
};
const Ps = { basic: 0, rooms: 1, presences: 2 }, sr = /* @__PURE__ */ Symbol("closed-editor-section");
...
mt([
  C({ attribute: !1 })
], si.prototype, "config", 2);
si = mt([
  D("ha-explorer-room-tools")
], si);
let dt = class extends pe {
  constructor() {
    super(...arguments), this.openEditorSections = /* @__PURE__ */ new Set(), this.activatedEditorSections = /* @__PURE__ */ new Set(), this.handleNativeControlChange = (e) => {
    ...
    }, this.handleLazySectionToggle = (e) => {
      const t = e.currentTarget, i = t.dataset.lazyEditorSection;
      i && this.setEditorSectionOpen(i, t.open);
    };
  }
  get currentConfig() {
    return this.config;
  ...
  firstUpdated() {
    this.renderRoot.addEventListener("change", this.handleNativeControlChange), this.renderRoot.addEventListener("click", this.handleItemCardClick), queueMicrotask(() => {
      this.isConnected && this.baseSections.forEach((e) => e.open = !1);
    });
  }
  disconnectedCallback() {
    this.renderRoot.removeEventListener("change", this.handleNativeControlChange), this.renderRoot.removeEventListener("click", this.handleItemCardClick), this.focusTimer !== void 0 && window.clearTimeout(this.focusTimer), this.focusTimer = void 0, super.disconnectedCallback();
  }
  get baseSections() {
  ...
  setEditorSectionOpen(e, t) {
    const i = this.openEditorSections.has(e), r = this.activatedEditorSections.has(e);
    if (i !== t) {
      const o = new Set(this.openEditorSections);
      t ? o.add(e) : o.delete(e), this.openEditorSections = o;
    }
    if (t && !r) {
      const o = new Set(this.activatedEditorSections);
      o.add(e), this.activatedEditorSections = o;
    }
  }
  handleEditorNavigate(e) {
    ...
    if (i !== void 0) {
      ...
      if (o) {
        const n = o.dataset.lazyEditorSection;
        n && this.setEditorSectionOpen(n, !0), o.open = !0, r = o;
      }
    }
    r && (r.classList.add("ux-focus"), r.scrollIntoView({ behavior: "smooth", block: "start" }), this.focusTimer !== void 0 && window.clearTimeout(this.focusTimer), this.focusTimer = window.setTimeout(() => {
      this.focusTimer = void 0, this.isConnected && r?.classList.remove("ux-focus");
    }, 1300));
  }
  renderLazyContent(e, t, i) {
    return this.activatedEditorSections.has(e) ? Er([t, t ? this.currentConfig : sr, t ? this.hass : sr], i) : f;
  }
  renderAdvancedSection(e, t, i, r, o) {
    const n = this.openEditorSections.has(e);
    return u`<details class="advanced-section" data-editor-section=${t} data-lazy-editor-section=${e} .open=${n} @toggle=${this.handleLazySectionToggle}><summary><span>${i}</span><span class="advanced-hint">${r}</span></summary><div class="advanced-content">${this.renderLazyContent(e, n, o)}</div></details>`;
  }
  render() {
    const e = this.currentConfig, t = this.openEditorSections.has("setup");
    return u`
    <details class="setup-section" data-lazy-editor-section="setup" .open=${t} @toggle=${this.handleLazySectionToggle}><summary><span>Opsætningsoversigt</span><span class="advanced-hint">Status & genveje</span></summary><div class="setup-content">${this.renderLazyContent("setup", t, () => u`<ha-explorer-setup-overview .hass=${this.hass} .config=${e} @explorer-editor-navigate=${this.handleEditorNavigate}></ha-explorer-setup-overview>`)}</div></details>
    ${super.render()}
    ...
    <div class="advanced-tools">
      ${this.renderAdvancedSection("appearance", "appearance", "Appearance", "Classic / Enchanted Antique", () => u`<ha-explorer-theme-editor .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-theme-editor>`)}
      ${this.renderAdvancedSection("room-tools", "room-tools", "Visuel rum-editor", "Tegn rum og presence-anchors", () => u`<ha-explorer-room-tools .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-room-tools>`)}
      ${this.renderAdvancedSection("identity", "presences", "Multi-Person & Identity", "Navne, profiler og separate mmWave-targets", () => u`<ha-explorer-identity-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-identity-editor>`)}
      ${this.renderAdvancedSection("presence-polish", "presences", "Visuel profil", "Farver, ikoner og synlighed", () => u`<ha-explorer-presence-polish-editor .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-presence-polish-editor>`)}
      ${this.renderAdvancedSection("movement-history", "presences", "Movement History 2.0", "1–5 min. historik og udtoning", () => u`<ha-explorer-movement-history-editor .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-movement-history-editor>`)}
      ${this.renderAdvancedSection("pet-robot-trails", "presences", "Pet & Robot Trails 2.0", "Poter, ruter og retning", () => u`<ha-explorer-pet-robot-trails-editor .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-pet-robot-trails-editor>`)}
      ${this.renderAdvancedSection("shelly-pet", "presences", "Shelly Pet Detection", "Kanin via Presence Gen4", () => u`<ha-explorer-shelly-pet-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-shelly-pet-editor>`)}
      ${this.renderAdvancedSection("openings", "openings", "Dynamic Doors & Windows", "Placér døre/vinduer, hængsel, sving og entity", () => u`<ha-explorer-openings-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-openings-editor>`)}
      ${this.renderAdvancedSection("zones", "zones", "Zones / Dynamic Areas", "Alarm, rengøring og dynamiske områder", () => u`<ha-explorer-zones-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-zones-editor>`)}
      ${this.renderAdvancedSection("room-reactions", "room-reactions", "Living Entity Points", "Lamper, TV, sensorer og temperatur", () => u`<ha-explorer-room-reactions-editor-clean .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-room-reactions-editor-clean>`)}
      ${this.renderAdvancedSection("room-actions", "room-actions", "Rumscener og hurtighandlinger", "Tænd/sluk alt, scenes og scripts", () => u`<ha-explorer-room-actions-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-room-actions-editor>`)}
      ${this.renderAdvancedSection("routes", "routes", "Route Network", "Manuelle routes og shared nodes", () => u`<ha-explorer-route-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-route-editor>`)}
      ${this.renderAdvancedSection("route-graph", "route-graph", "Automatic Route Graph", "Graph edges, døre og live conditions", () => u`<ha-explorer-route-graph-editor .hass=${this.hass} .config=${e} @config-changed=${this.handleToolConfigChanged}></ha-explorer-route-graph-editor>`)}
      ${this.renderAdvancedSection("diagnostics", "diagnostics", "Route Preview & Diagnostics", "Kontrollér graph og resolved routes", () => u`<ha-explorer-route-diagnostics .hass=${this.hass} .config=${e}></ha-explorer-route-diagnostics>`)}
    </div>`;
  }
  dispatchEvent(e) {
...
function Oe(e) {
  return { x: ar(e.x), y: ar(e.y) };
}
function Ms(e) {
  return [e.id, e.area_id, e.name, ...e.aliases ?? []].filter((t) => typeof t == "string" && t.trim().length > 0).map(Tr);
}
function zr(e, t) {
  if (!t?.trim()) return;
  const i = Tr(t);
  return e.find((r) => Ms(r).includes(i));
}
function Ts(e) {
  if (e.presence_anchor) return Oe(e.presence_anchor);
  if (e.label) return Oe(e.label);
  const t = Rs(e.points);
  if (t && ri(t, e.points))
    return Oe({ x: t[0], y: t[1] });
  const i = Ns(e.points);
  if (ri(i, e.points))
    return Oe({ x: i[0], y: i[1] });
  if (e.points.length) {
    const r = e.points.map(([s]) => s), o = e.points.map(([, s]) => s), n = [
      (Math.min(...r) + Math.max(...r)) / 2,
      (Math.min(...o) + Math.max(...o)) / 2
    ];
    return ri(n, e.points) ? Oe({ x: n[0], y: n[1] }) : Oe({ x: e.points[0][0], y: e.points[0][1] });
  }
  return { x: 0.5, y: 0.5 };
}
...
function lr(e, t) {
  return Math.max(1, Math.round(jt(e) ?? t));
}
function zs(e) {
  const t = Math.max(0.05, jt(e.max_height_m) ?? 0.75);
  return {
    ...
    maxHeight: t,
    releaseHeight: Math.max(t + 0.05, jt(e.release_height_m) ?? t + 0.2),
    confirmationUpdates: lr(e.confirmation_updates, 3),
    releaseUpdates: lr(e.release_updates, 2)
  };
}
function Ds() {
  ai.clear();
...
function Is(e, t) {
  ...
  const r = zs(i), o = jt(t.attributes[r.heightAttribute]);
  ...
  let c = ai.get(e.id);
  return (!c || c.targetId !== s) && (c = { targetId: s, low: 0, high: 0, confirmed: !1 }, ai.set(e.id, c)), c.lastSample === l ? { ...e, type: "pet", visible: e.visible !== !1 && c.confirmed } : (c.lastSample = l, o <= r.maxHeight ? (c.low += 1, c.high = 0, c.low >= r.confirmationUpdates && (c.confirmed = !0)) : o >= r.releaseHeight ? (c.high += 1, c.low = 0, c.high >= r.releaseUpdates && (c.confirmed = !1)) : (c.low = 0, c.high = 0), { ...e, type: "pet", visible: e.visible !== !1 && c.confirmed });
}
const js = ["unknown", "unavailable", "not_detected"], qs = /* @__PURE__ */ new Set(["", "unknown", "unavailable", "none", "null"]);
function ie(e, t) {
...
function cr(e) {
  ...
  const t = e.trim();
  return qs.has(t.toLowerCase()) ? void 0 : t;
}
function Os(e, t, i) {
  if (e.room_entity) {
    const r = i.states[e.room_entity];
    return r ? cr(e.room_attribute ? ie(r, e.room_attribute) : r.state) : void 0;
  }
  if (t)
    return cr(ie(t, e.room_attribute ?? "explorer_room"));
}
function Bs(e) {
...
function dr(e, t, i, r, o, n) {
  const s = i - t;
  return Math.abs(s) < 1e-6 ? n : r + (e - t) / s * (o - r);
}
function pr(e, t, i, r, o, n, s) {
...
function Hs(e, t, i) {
  const r = e.physical_meters, o = me(r?.width), n = me(r?.height), s = Bs(e);
  ...
  return p?.c ? (c = pr(a, l, p.a, p.b, p.c, "room_x", c), d = pr(a, l, p.a, p.b, p.c, "room_y", d)) : p && (c = dr(a, p.a.sensor_x, p.b.sensor_x, p.a.room_x, p.b.room_x, c), d = dr(l, p.a.sensor_y, p.b.sensor_y, p.a.room_y, p.b.room_y, d)), c = Math.min(1, Math.max(0, c)), d = Math.min(1, Math.max(0, d)), { x: s.minX + c * (s.maxX - s.minX), y: s.minY + d * (s.maxY - s.minY) };
}
function kt(e, t, i) {
  const r = zr(t, i ?? e.room_id);
  if (r) {
    const s = Ts(r);
...
function Fs(e, t, i, r, o, n) {
  ...
  if (t.coordinate_space === "room_meters") {
    const c = me(ie(i, a)), d = me(ie(i, l)), p = zr(r, o ?? e.room_id);
    return c === void 0 || d === void 0 || !p ? {} : { ...Hs(p, c, d), roomId: p.id };
  }
...
function Zs(e, t, i = [], r) {
  ...
  if (!o || !t) return kt(e, i);
  const n = o.entity ? t.states[o.entity] : void 0, s = o.position_entity ?? o.entity, a = s ? t.states[s] : void 0;
  if (o.entity && !n) return { ...kt(e, i), visible: !1 };
  if (o.position_entity && !a) return { ...kt(e, i), visible: !1 };
  const l = o.hidden_states ?? js, c = n ? l.includes(n.state) : !1, d = a && a !== n ? l.includes(a.state) : !1, p = ie(n, o.visible_attribute), h = c || d ? !1 : Ls(p, e.visible ?? !0), g = Os(o, n, t) ?? e.room_id, b = Fs(e, o, a, i, g, r), m = { ...e, x: b.x, y: b.y, room_id: b.roomId ?? e.room_id, name: e.name ?? wt(ie(n, o.name_attribute ?? "friendly_name")), avatar: e.avatar ?? wt(ie(n, o.avatar_attribute ?? "entity_picture")), icon: e.icon ?? (o.icon_attribute ? wt(ie(n, o.icon_attribute)) : void 0), color: e.color ?? wt(ie(n, o.color_attribute ?? "explorer_color")), visible: h }, y = o.coordinate_space === "room_meters" ? m.x === void 0 || m.y === void 0 ? { ...m, visible: !1 } : m : kt(m, i, g);
  return Is(y, a);
}
function Vs(e, t, i = [], r) {
  return e.map((o) => Zs(o, t, i, r));
}
const Fe = /* @__PURE__ */ new Map(), Ks = 0.22, Ws = 0.16, Gs = 3e4, Us = 0.025, Xs = 0.018;
function qt(e) {
...
function Ys(e, t) {
  const i = qt(t), r = li(e.point, i), o = li(Dr(e), i), n = e.target && e.target === et(t) ? Us : 0;
...
function Qs(e, t = Date.now()) {
  for (const [a, l] of Fe) t - l.seenAt > Gs && Fe.delete(a);
  const i = e.filter((a) => (a.type ?? "person") === "person" && a.visible !== !1 && qt(a) && et(a)), r = new Set(i), o = e.filter((a) => !r.has(a)), n = /* @__PURE__ */ new Map();
  for (const a of i) {
  ...
  for (const a of n.values()) {
    ...
    const l = [...a], c = [...a].sort((g, b) => He(g).localeCompare(He(b))), d = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Set(), h = c.map((g) => {
      ...
      const m = l.map((y) => Ys(b, y)).sort((y, S) => y.score - S.score);
    ...
    for (const g of h) {
      ...
      const S = y[0], w = y[1], k = S.distance <= Ks || li(Dr(m), qt(S.candidate)) <= Ws, E = !!w && w.score - S.score < Xs;
...
var $s = Object.defineProperty, _s = Object.getOwnPropertyDescriptor, Ht = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? _s(t, i) : t, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (o = (r ? s(t, i, o) : s(o)) || o);
...
let Ue = class extends O {
  ...
  renderCastleSurround(e) {
    ...
    >
      <div
        ...
        style=${`background-image: url("${go}")`}
      ></div>
      <div
        class="castle-cinematic-backdrop castle-cinematic-night"
        style=${`background-image: url("${uo}")`}
      ></div>
  ...
  render() {
    if (!this.config) return f;
    const e = this.config.image ?? this.config.background ?? "", t = this.defaultRoom(), i = Vs(
      this.config.presences ?? [],
      this.hass,
      t,
      this.config.floorplan_meters
    ), r = Qs(i), o = this.config.appearance?.theme ?? "classic", n = o === "enchanted_antique", s = this.isNight(), a = Math.min(
      1,
    ...
    return u`${this.renderCastleSurround(s)}<ha-card
      ...
      ><header>
        ...
        <small>Enchanted Atmosphere · v${Ir}</small>
      </header>
      <div class="map-stage">
...
console.info(
  `%c HOME ASSISTANT EXPLORER %c v${Ir} `,
